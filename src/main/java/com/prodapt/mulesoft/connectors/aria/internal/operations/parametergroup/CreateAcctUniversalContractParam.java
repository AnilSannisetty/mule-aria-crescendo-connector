...
public class CreateAcctUniversalContractParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to create a universal contract for a specified account holder.")
	@Optional(defaultValue = "create_acct_universal_contract_m")
