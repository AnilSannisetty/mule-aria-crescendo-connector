...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetClientPlanServiceRatesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetClientPlanServiceRates {
	private static final Logger logger = LoggerFactory.getLogger(GetClientPlanServiceRates.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Client Plan Service Rates")
	@MediaType(value = "application/json")
	@Summary("This operation returns information about the rates for a particular service in a specified plan.")
	public void getClientPlanServiceRates(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetClientPlanServiceRatesParam ar,
		...
		String apiName = "get_client_plan_service_rates_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetClientPlanServiceRatesParam ar) {
