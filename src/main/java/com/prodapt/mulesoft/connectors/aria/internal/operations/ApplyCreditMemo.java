...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ApplyCreditMemoParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ApplyCreditMemo {
	private static final Logger logger = LoggerFactory.getLogger(ApplyCreditMemo.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Apply Credit Memo")
	@MediaType(value = "application/json")
	@Summary("This operation applies credit memo line credits to invoice gross line amounts.")
	public void applyCreditMemo(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ApplyCreditMemoParam ar,
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ApplyCreditMemoParam ar) {
