...
public class GetAcctServiceOutageCreditParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to retrieve the service outage for an account or master plan instance.")
	@Optional(defaultValue = "get_acct_service_outage_credit_m")
