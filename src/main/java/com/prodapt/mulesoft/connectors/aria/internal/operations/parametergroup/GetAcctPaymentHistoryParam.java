...
public class GetAcctPaymentHistoryParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to return a list of payments associated with an account.")
	@Optional(defaultValue = "get_acct_payment_history_m")
