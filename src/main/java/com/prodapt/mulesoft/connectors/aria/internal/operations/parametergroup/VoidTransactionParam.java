...
public class VoidTransactionParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that voids a particular transaction associated with a specified account.")
	@Optional(defaultValue = "void_transaction_m")
