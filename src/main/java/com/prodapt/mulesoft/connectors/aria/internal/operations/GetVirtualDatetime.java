...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetVirtualDatetimeParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetVirtualDatetime {
	private static final Logger logger = LoggerFactory.getLogger(GetVirtualDatetime.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Virtual Datetime")
	@MediaType(value = "application/json")
	@Summary("This operation returns the current virtual date, and virtual time for the given client.")
	public void getVirtualDatetime(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetVirtualDatetimeParam ar,
		...
		String apiName = "get_virtual_datetime_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetVirtualDatetimeParam ar) {
