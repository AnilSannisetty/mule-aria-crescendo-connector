...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctPlanUnitInstanceAllParam;
...
public class GetAcctPlanUnitInstanceAll {
	...
	public void getAcctPlanUnitInstanceAll(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctPlanUnitInstanceAllParam ar,
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctPlanUnitInstanceAllParam ar) {
