...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ApplyCashCreditParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ApplyCashCredit {
	private static final Logger logger = LoggerFactory.getLogger(ApplyCashCredit.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Apply Cash Credit")
	@MediaType(value = "application/json")
	@Summary("This operations is used to apply a cash credit to an account, account-level charge, invoice, or invoice charge.")
	public void applyCashCredit(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ApplyCashCreditParam ar,
		...
		String apiName = "apply_cash_credit_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ApplyCashCreditParam ar) {
