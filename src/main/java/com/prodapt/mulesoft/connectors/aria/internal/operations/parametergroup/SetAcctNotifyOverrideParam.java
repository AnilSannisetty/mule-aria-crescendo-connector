...
public class SetAcctNotifyOverrideParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to assign or remove the alternate message template for the given template class.")
	@Optional(defaultValue = "set_acct_notify_override_m")
