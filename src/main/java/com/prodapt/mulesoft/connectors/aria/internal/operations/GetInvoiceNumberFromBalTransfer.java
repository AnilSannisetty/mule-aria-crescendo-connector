...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetInvoiceNumberFromBalTransferParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetInvoiceNumberFromBalTransfer {
	private static final Logger logger = LoggerFactory.getLogger(GetInvoiceNumberFromBalTransfer.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Invoice Number From Balance Transfer")
	@MediaType(value = "application/json")
	@Summary("This operation returns the invoice number associated with a specified balance transfer and master plan instance.")
	public void getInvoiceNumberFromBalTransfer(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetInvoiceNumberFromBalTransferParam ar,
		...
		String apiName = "get_inv_no_from_bal_xfer_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetInvoiceNumberFromBalTransferParam ar) {
