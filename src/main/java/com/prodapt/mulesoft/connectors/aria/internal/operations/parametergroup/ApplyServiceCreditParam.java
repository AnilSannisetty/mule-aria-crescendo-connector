...
public class ApplyServiceCreditParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that applies a service credit to a specified account or a master plan instance.")
	@Optional(defaultValue = "apply_service_credit_m")
