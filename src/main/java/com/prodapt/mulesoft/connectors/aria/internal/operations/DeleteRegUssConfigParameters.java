...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.DeleteRegUssConfigParametersParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class DeleteRegUssConfigParameters  {
	private static final Logger logger = LoggerFactory.getLogger(DeleteRegUssConfigParameters .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Delete Registration USS Configuration Parameters")
	@MediaType(value = "application/json")
	@Summary("This operation removes the parameter name-value pairs in a specified configuration set created using the set_reg_uss_config_params operation.")
			
	public void deleteRegUssConfigParameters(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") DeleteRegUssConfigParametersParam ar,
		...
		String apiName = "delete_reg_uss_config_params_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, DeleteRegUssConfigParametersParam ar) {
