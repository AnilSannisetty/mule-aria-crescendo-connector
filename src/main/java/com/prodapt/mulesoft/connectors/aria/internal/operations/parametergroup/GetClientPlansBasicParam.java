...
public class GetClientPlansBasicParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get summary list of all plans associated with a client.")
	@Optional(defaultValue = "get_client_plans_basic_m")
