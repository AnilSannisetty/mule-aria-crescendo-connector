...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetItemsBySupplementalFieldParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetItemsBySupplementalField {
	private static final Logger logger = LoggerFactory.getLogger(GetItemsBySupplementalField.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Items By Supplemental Field")
	@MediaType(value = "application/json")
	@Summary("This operation returns the inventory items associated with a particular value for a supplemental object field.")
	public void getItemsBySupplementalField(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetItemsBySupplementalFieldParam ar,
		...
		String apiName = "get_items_by_supp_field_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetItemsBySupplementalFieldParam ar) {
