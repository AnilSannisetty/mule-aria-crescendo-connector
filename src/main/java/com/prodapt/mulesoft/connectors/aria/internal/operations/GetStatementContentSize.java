...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetStatementContentSizeParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetStatementContentSize {
	private static final Logger logger = LoggerFactory.getLogger(GetStatementContentSize.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Statement Content Size")
	@MediaType(value = "application/json")
	@Summary("This operation returns the number of characters in the given statement.")
	public void getStatementContentSize(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetStatementContentSizeParam ar,
		...
		String apiName = "get_statement_content_size_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetStatementContentSizeParam ar) {
