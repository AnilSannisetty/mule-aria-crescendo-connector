...
public class GetDailyBatchStatusParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get current status of the Net Terms/Statement Status Mgr batch job for the given client and date.")
	@Optional(defaultValue = "get_daily_batch_status_m")
