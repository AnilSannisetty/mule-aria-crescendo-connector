...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetCcUuidParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetCcUuid {
	private static final Logger logger = LoggerFactory.getLogger(GetCcUuid.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get CC UUID")
	@MediaType(value = "application/json")
	@Summary("This operation returns the universally unique identifier (UUID) for a credit card payment number.")
	public void getCcUuid(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetCcUuidParam ar,
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetCcUuidParam ar) {
