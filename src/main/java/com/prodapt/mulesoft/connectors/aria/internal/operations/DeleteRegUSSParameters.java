...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.DeleteRegUSSParametersParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class DeleteRegUSSParameters  {
	private static final Logger logger = LoggerFactory.getLogger(DeleteRegUSSParameters .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Delete Registration USS Parameters")
	@MediaType(value = "application/json")
	@Summary("This operation removes the parameter name-value pairs in a particular session.")
			
	public void deleteRegUSSParameters(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") DeleteRegUSSParametersParam ar,
		...
		String apiName = "delete_reg_uss_params_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, DeleteRegUSSParametersParam ar) {
