...
public class  UserIDIsAvailableParam {
	
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that determines whether a specified user ID is available for use.")
	@Optional(defaultValue = "userid_is_available_m")
