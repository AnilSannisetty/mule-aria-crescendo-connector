...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.AuthorizeElctronicPaymentParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class AuthorizeElectronicPayment {
	private static final Logger logger = LoggerFactory.getLogger(AuthorizeElectronicPayment.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Authorize Electronic Payment")
	@MediaType(value = "application/json")
	@Summary("This operation authorizes a card for a specified amount. This API call does not collect a payment.")
			
	public void authorizeElectronicPayment(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") AuthorizeElctronicPaymentParam ar,
		...
		String apiName = "authorize_electronic_payment_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, AuthorizeElctronicPaymentParam ar) {
