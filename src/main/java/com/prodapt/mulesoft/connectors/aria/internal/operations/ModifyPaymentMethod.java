...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyPaymentMethodParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ModifyPaymentMethod {
	...
	@Summary("Allows to update payment method-related information associated with an account.")
	public void modifyPaymentMethod(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ModifyPaymentMethodParam ar,
		...
		String apiName = "update_payment_method_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyPaymentMethodParam ar) {
