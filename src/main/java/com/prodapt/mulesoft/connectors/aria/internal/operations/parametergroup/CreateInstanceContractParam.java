...
public class CreateInstanceContractParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to create a multi-plan contract for a specified account holder and specified list of plans.")
	@Optional(defaultValue = "create_instance_contract_m")
