...
public class ReplaceREGUSSParamsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to replace the parameter name-value pairs in a particular configuration set with a specified set of new parameter name-value pairs.")
	@Optional(defaultValue = "replace_reg_uss_params_m")
