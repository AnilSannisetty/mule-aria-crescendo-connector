...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetEmailTemplatesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetEmailTemplates {
	private static final Logger logger = LoggerFactory.getLogger(GetEmailTemplates.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Email Templates")
	@MediaType(value = "application/json")
	@Summary("This operation returns the list of email templates associated with a client.")
	public void getEmailTemplates(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetEmailTemplatesParam ar,
		...
		String apiName = "get_email_templates_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetEmailTemplatesParam ar) {
