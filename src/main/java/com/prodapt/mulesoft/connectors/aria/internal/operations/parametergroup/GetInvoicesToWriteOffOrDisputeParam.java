...
public class GetInvoicesToWriteOffOrDisputeParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to retrieve eligible invoices to write-off or dispute.")
	@Optional(defaultValue = "get_invoices_to_writeoff_or_dispute_m")
