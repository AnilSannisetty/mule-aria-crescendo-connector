...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctOpenChargesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctOpenCharges {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctOpenCharges.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Open Charges")
	@MediaType(value = "application/json")
	@Summary("This operation is used to retrieve open charges for a given account.")
	public void getAcctOpenCharges(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctOpenChargesParam ar,
		...
		String apiName = "get_acct_open_charges_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctOpenChargesParam ar) {
