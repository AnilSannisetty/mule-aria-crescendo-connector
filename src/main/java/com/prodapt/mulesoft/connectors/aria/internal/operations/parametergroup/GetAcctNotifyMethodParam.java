...
public class GetAcctNotifyMethodParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns the method by which statements are sent to a specified account.")
	@Optional(defaultValue = "get_acct_notify_method_m")
