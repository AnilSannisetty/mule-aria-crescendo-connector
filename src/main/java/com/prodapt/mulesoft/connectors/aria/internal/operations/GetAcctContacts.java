...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctContactsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctContacts {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctContacts.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Contacts")
	@MediaType(value = "application/json")
	@Summary("This operation returns all the contacts for the specified client account and/or billing group and information about them (e.g. their locations and whether it is an account, billing, backup, or statement contact).")
	public void getAcctContacts(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctContactsParam ar,
		...
		String apiName = "get_acct_contacts_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctContactsParam ar) {
