...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctPaymentHistoryParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctPaymentHistory {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctPaymentHistory.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Payment History")
	@MediaType(value = "application/json")
	@Summary("This operation returns a list of payments associated with an account.")
	public void getAcctPaymentHistory(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctPaymentHistoryParam ar,
		...
		String apiName = "get_acct_payment_history_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctPaymentHistoryParam ar) {
