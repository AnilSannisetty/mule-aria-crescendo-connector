...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctNotificationDetailsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctNotificationDetails {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctNotificationDetails.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Notification Details")
	@MediaType(value = "application/json")
	@Summary("This operation returns the notification details associated with a specified account.")
	public void getAcctNotificationDetails(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctNotificationDetailsParam ar,
		...
		String apiName = "get_acct_notification_details_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctNotificationDetailsParam ar) {
