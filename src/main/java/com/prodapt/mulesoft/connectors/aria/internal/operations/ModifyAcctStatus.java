...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyAcctStatusParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ModifyAcctStatus {
	...
	public void modifyAcctStatus(@Config RestConfiguration rc, @Connection AriaConnection ac,
		...
		String apiName = "update_acct_status_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyAcctStatusParam ar) {
