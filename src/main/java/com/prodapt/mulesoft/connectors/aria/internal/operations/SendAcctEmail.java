...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SendAcctEmailParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class SendAcctEmail  {
	private static final Logger logger = LoggerFactory.getLogger(SendAcctEmail .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Send Account Email")
	@MediaType(value = "application/json")
	@Summary("This operation sends a specified message type to a particular account holder identified by a user ID.")			
	public void sendAcctEmail(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SendAcctEmailParam ar,
		...
		String apiName = "send_acct_email_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SendAcctEmailParam ar) {
