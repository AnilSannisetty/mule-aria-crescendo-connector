...
public class GetClientCurrenciesParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns a list of currencies assigned to a client.")
	@Optional(defaultValue = "get_client_currencies_m")
