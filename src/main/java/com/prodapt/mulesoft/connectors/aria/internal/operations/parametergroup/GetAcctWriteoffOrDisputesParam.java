...
public class GetAcctWriteoffOrDisputesParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to retrieve the write-offs and disputes made on the account or master plan instance.")
	@Optional(defaultValue = "get_acct_writeoff_or_disputes_m")
