...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GenRandomStringParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GenRandomString {
	private static final Logger logger = LoggerFactory.getLogger(GenRandomString.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Generate Random String")
	@MediaType(value = "application/json")
	@Summary("This operation generates a random string of letters and/or numbers.")
	public void genRandomString(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GenRandomStringParam ar,
		...
		String apiName = "gen_random_string_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GenRandomStringParam ar) {
