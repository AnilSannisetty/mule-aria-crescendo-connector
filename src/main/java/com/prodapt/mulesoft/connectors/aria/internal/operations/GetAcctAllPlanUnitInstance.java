...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctAllPlanUnitInstanceParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctAllPlanUnitInstance {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctAllPlanUnitInstance.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("CRUD:Get Account Plan Unit Instance All")
	@MediaType(value = "application/json")
	@Summary("Array of all Plan Unit Instances and related Plan Unit Instance fields for all the plans under the account.")
	public void getAcctPlanUnitInstanceAll(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctAllPlanUnitInstanceParam ar,
		...
		String apiName = "get_acct_plan_unit_instance_all_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctAllPlanUnitInstanceParam ar) {
