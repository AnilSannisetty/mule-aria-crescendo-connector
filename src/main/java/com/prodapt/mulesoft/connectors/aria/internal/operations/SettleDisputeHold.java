...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SettleDisputeHoldParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class SettleDisputeHold {
	private static final Logger logger = LoggerFactory.getLogger(SettleDisputeHold.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Settle Dispute Hold")
	@MediaType(value = "application/json")
	@Summary("This operation is used to settle dispute for the given dispute number.")
	public void settleDisputeHold(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SettleDisputeHoldParam ar,
		...
		String apiName = "settle_dispute_hold_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SettleDisputeHoldParam ar) {
