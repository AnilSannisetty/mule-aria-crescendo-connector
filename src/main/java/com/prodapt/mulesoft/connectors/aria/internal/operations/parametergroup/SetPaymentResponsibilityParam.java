...
public class  SetPaymentResponsibilityParam  {
	
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that specifies the master plan instance on a parent account that is responsible for paying the invoices associated with a master plan instance for a child account.")
	@Optional(defaultValue = "set_payment_responsibility_m")
