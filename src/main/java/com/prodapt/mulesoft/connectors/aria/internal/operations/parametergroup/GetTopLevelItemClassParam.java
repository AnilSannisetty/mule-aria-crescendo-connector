...
public class GetTopLevelItemClassParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get all the parent classes for that client.")
	@Optional(defaultValue = "get_top_level_item_class_m")
