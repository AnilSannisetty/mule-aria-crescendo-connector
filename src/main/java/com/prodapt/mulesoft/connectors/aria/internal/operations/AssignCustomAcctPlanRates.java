...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.AssignCustomAcctPlanRatesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class AssignCustomAcctPlanRates {
	private static final Logger logger = LoggerFactory.getLogger(AssignCustomAcctPlanRates.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Assign Custom Account Plan Rates")
	@MediaType(value = "application/json")
	@Summary("This operation applies custom rates to a particular plan instance and service assigned to a specified account. Please note: Custom rates can be assigned to only recurring and usage-based services.")
	public void assignCustomAcctPlanRates(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") AssignCustomAcctPlanRatesParam ar,
		...
		String apiName = "assign_custom_acct_plan_rates_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, AssignCustomAcctPlanRatesParam ar) {
