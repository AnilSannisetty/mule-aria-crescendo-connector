...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.UpdateRefundCheckNumberParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class UpdateRefundCheckNumber  {
	private static final Logger logger = LoggerFactory.getLogger(UpdateRefundCheckNumber .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Update Refund Check Number")
	@MediaType(value = "application/json")
	@Summary("This operation updates the refund check number on a refund processed without a check number earlier.")
			
	public void updateRefundCheckNumber(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") UpdateRefundCheckNumberParam ar,
		...
		String apiName = "update_refund_check_no_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, UpdateRefundCheckNumberParam ar) {
