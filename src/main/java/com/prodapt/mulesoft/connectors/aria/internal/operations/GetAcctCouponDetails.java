...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctCouponDetailsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctCouponDetails {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctCouponDetails.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("CRUD:Get Account Coupon Details")
	@MediaType(value = "application/json")
	@Summary("This API provides detailed information including credit templates, discount rules, and discount bundles for coupons that are assigned to an account or a master plan instance.")
	public void getAcctCouponDetailsParam(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctCouponDetailsParam ar,
		...
		String apiName = "get_acct_coupon_details_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctCouponDetailsParam ar) {
