...
public class AssignFunctionalAcctGroupParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to assign functional account group.")
	@Optional(defaultValue = "assign_functional_acct_group_m")
