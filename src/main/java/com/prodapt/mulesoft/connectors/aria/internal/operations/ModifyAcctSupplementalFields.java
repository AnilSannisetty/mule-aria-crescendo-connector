...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyAcctSupplementalFieldsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ModifyAcctSupplementalFields {
	private static final Logger logger = LoggerFactory.getLogger(ModifyAcctSupplementalFields.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Modify Account Supplemental Fields")
	@MediaType(value = "application/json")
	@Summary("This operation is used to update or delete one or more supplemental fields and/or values associated with a specified account ")
	public void modifyAcctSupplementalFields(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ModifyAcctSupplementalFieldsParam ar,
		...
		String apiName = "modify_acct_supp_fields_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyAcctSupplementalFieldsParam ar) {
