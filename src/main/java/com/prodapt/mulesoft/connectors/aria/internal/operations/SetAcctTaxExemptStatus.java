...
public class SetAcctTaxExemptStatus {
	private static final Logger logger = LoggerFactory.getLogger(SetAcctTaxExemptStatus.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Set Account Tax Exempt Status")
	@MediaType(value = "application/json")
	@Summary("This operation sets the tax exemption level for a specified account.")
	public void setaccttaxexemptstatus(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SetAcctTaxExemptStatusParam ar,
		...
		String apiName = "set_acct_tax_exempt_status_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SetAcctTaxExemptStatusParam ar) {
