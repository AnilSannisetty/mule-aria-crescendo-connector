...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetUnappliedPaymentsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetUnappliedPayments{
	private static final Logger logger = LoggerFactory.getLogger(GetUnappliedPayments.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Unapplied Payments")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to retrieve the balance of unapplied payments for a specified account.")
	public void getUnappliedPayments(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetUnappliedPaymentsParam ar,
		...
		String apiName = "get_unapplied_payments_m";
