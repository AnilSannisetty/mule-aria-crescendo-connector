...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetClientItemClassesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetClientItemClasses{
	private static final Logger logger = LoggerFactory.getLogger(GetClientItemClasses.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Client Item Classes")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to return a list of classes for inventory item.")
	public void getClientItemClasses(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetClientItemClassesParam ar,
		...
		String apiName = "get_client_item_classes_m";
