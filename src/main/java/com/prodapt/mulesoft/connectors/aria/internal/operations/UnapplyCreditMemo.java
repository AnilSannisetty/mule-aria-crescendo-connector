...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.UnapplyCreditMemoParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class UnapplyCreditMemo {
	private static final Logger logger = LoggerFactory.getLogger(UnapplyCreditMemo.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Unapply Credit Memo")
	@MediaType(value = "application/json")
	@Summary("This operation unapplies credit memo line credits from invoice gross line.")
	public void unapplyCreditMemo(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") UnapplyCreditMemoParam ar,
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, UnapplyCreditMemoParam ar) {
