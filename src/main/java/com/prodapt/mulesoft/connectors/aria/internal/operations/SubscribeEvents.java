...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SetSessionParam;
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SubscribeEventsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class SubscribeEvents {
	private static final Logger logger = LoggerFactory.getLogger(SubscribeEvents.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Subscribe Events")
	@MediaType(value = "application/json")
	@Summary("This operation subscribes a client to a specified group of event notifications. Please note: In order for this operation to work, the client must already be subscribed to the event class to which the specified events belong.")
	public void subscribeevents(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SubscribeEventsParam ar,
		...
		String apiName = "subscribe_events_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SubscribeEventsParam ar) {
