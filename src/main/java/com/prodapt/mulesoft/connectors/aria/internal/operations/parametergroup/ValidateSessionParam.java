...
public class ValidateSessionParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that determines the validity of a specified session and the user with which a session ID is associated.")
	@Optional(defaultValue = "validate_session_m")
