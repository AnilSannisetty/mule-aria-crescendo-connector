...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctGroupsByClientParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctGroupsByClient{
	private static final Logger logger = LoggerFactory.getLogger(GetAcctGroupsByClient.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Groups By Client")
	@MediaType(value = "application/json")
	@Summary("This operation can be used retrieve the list of account groups associated with a client.")
	public void getAcctGroupsByClient(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctGroupsByClientParam ar,
		...
		String apiName = "get_acct_groups_by_client_m";
