...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.RemoveAcctPlanCustomRatesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class RemoveAcctPlanCustomRates {
	private static final Logger logger = LoggerFactory.getLogger(RemoveAcctPlanCustomRates.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Remove Account Plan Custom Rates")
	@MediaType(value = "application/json")
	@Summary("This operation removes custom rates from the specified account and plan.")
	public void removeAcctPlanCustomRates(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") RemoveAcctPlanCustomRatesParam ar,
		...
		String apiName = "remove_acct_plan_custom_rates_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, RemoveAcctPlanCustomRatesParam ar) {
