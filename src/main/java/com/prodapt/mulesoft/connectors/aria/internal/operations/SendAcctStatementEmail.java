...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SendAcctStatementEmailParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class SendAcctStatementEmail {
	private static final Logger logger = LoggerFactory.getLogger(SendAcctStatementEmail.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Send Account Statement Email")
	@MediaType(value = "application/json")
	@Summary("This operation has the ability to send a statement to a customer on an on-demand basis.")
	public void sendAcctStatementEmail(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SendAcctStatementEmailParam ar,
		...
		String apiName = "send_acct_statement_email_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SendAcctStatementEmailParam ar) {
