...
public class GetClientPlansAllParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get a detailed list of all plans associated with a client.")
	@Optional(defaultValue = "get_client_plans_all_m")
