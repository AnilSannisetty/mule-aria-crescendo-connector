...
public class ReverseAuthorizedElectronicPaymentParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to reverse an authorized electronic payment for an account.")
	@Optional(defaultValue = "reverse_authorized_electronic_payment_m")
