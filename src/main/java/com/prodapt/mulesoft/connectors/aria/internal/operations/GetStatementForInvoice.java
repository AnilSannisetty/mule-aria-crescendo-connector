...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetStatementForInvoiceParam;
...
public class GetStatementForInvoice {
	...
	public void getStatementForInvoice(@Config RestConfiguration rc, @Connection AriaConnection ac,
		...
		String apiName = "get_statement_for_invoice_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetStatementForInvoiceParam ar) {
