...
public class RecordMandateApprovalParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that electronically verifies that the end user (Aria account holder) has physically signed a SEPA Direct Debit mandate. Payments can only be made with SEPA Tokenized Direct Debit after the mandate has been approved with this API call.")
	@Optional(defaultValue = "record_mandate_approval_m")
