...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.AuthenticateCallerParam;
...
public class AuthenticateCaller {
	private static final Logger logger = LoggerFactory.getLogger(AuthenticateCaller.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Authenticate Caller")
	@MediaType(value = "application/json")
	@Summary("This operation is used to verify a client number and auth key combination.")
	public void authenticatecaller(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") AuthenticateCallerParam ar,
		...
		String apiName = "authenticate_caller_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, AuthenticateCallerParam ar) {
