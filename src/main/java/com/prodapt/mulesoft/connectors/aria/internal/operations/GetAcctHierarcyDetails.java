...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctHierarcyDetailsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctHierarcyDetails {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctHierarcyDetails.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("CRUD:Get Account Hierarchy Details")
	@MediaType(value = "application/json")
	@Summary("Used to retrieve the account details, and also the details of its master plan instances, supplemental plan instances, billing groups, and payment methods (based on various filter flags in the input). It is also capable of fetching the details of its parent and child account details.")
	public void getAcctHierarchyDetails(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctHierarcyDetailsParam ar,
		...
		String apiName = "get_acct_hierarchy_details_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctHierarcyDetailsParam ar) {
