...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ReverseAuthorizedElectronicPaymentParam;
...
public class ReverseAuthorizedElectronicPayment {
	...
	private static final Logger logger = LoggerFactory.getLogger(ReverseAuthorizedElectronicPayment.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Reverse Authorized Electronic Payment")
	@MediaType(value = "application/json")
	@Summary("Use this operation to reverse an authorized electronic payment for an account."
			+ " Criteria for reversing an authorized electronic payment include that the initial payment "
			+ "should have been made within the last 72 hours and the payment method was a credit card, or tokenized credit card.")
	public void reverseAuthorizedElectronicPayment(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ReverseAuthorizedElectronicPaymentParam ar,
		...
		String apiName = "reverse_authorized_electronic_payment_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ReverseAuthorizedElectronicPaymentParam ar) {
