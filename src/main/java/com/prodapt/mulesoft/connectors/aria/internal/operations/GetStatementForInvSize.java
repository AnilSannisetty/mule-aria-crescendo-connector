...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetStatementForInvSizeParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetStatementForInvSize {
	private static final Logger logger = LoggerFactory.getLogger(GetStatementForInvSize.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Statement For Invoice Size")
	@MediaType(value = "application/json")
	@Summary("This operation returns the number of characters in a statement associated with a specified account and invoice.")
	public void getStatementForInvSize(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetStatementForInvSizeParam ar,
		...
		String apiName = "get_statement_for_inv_size_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetStatementForInvSizeParam ar) {
