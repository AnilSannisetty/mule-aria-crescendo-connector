...
public class GetClientItemsBasicParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns a list of inventory items associated with a client.")
	@Optional(defaultValue = "get_client_items_basic_m")
