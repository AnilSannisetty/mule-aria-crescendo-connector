...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAufStatusParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAufStatus{
	private static final Logger logger = LoggerFactory.getLogger(GetAufStatus.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get AUF Status")
	@MediaType(value = "application/json")
	@Summary("This operation returns the upload statistics for a specified client usage file.")
	public void getAufStatus(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAufStatusParam ar,
		...
		String apiName = "get_auf_status_m";
