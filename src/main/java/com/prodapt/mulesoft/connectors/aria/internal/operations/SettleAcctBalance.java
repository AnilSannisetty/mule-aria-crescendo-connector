...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SettleAcctBalanceParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class SettleAcctBalance {
	...
	@Summary("This API is used to collect the outstanding balance for a specific master plan instance, OR an account.")
	public void settleAccountBalance(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SettleAcctBalanceParam ar,
		...
		String apiName = "settle_account_balance_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SettleAcctBalanceParam ar) {
