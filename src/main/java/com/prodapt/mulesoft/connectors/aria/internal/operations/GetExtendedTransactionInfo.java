...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetExtendedTransactionInfoParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetExtendedTransactionInfo {
	private static final Logger logger = LoggerFactory.getLogger(GetExtendedTransactionInfo.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Extended Transaction Information")
	@MediaType(value = "application/json")
	@Summary("This operation returns the list of optional transaction qualifiers submitted for the given Transaction ID.")
	public void getExtendedTransactionInfo(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetExtendedTransactionInfoParam ar,
		...
		String apiName = "get_extended_transaction_info_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetExtendedTransactionInfoParam ar) {
