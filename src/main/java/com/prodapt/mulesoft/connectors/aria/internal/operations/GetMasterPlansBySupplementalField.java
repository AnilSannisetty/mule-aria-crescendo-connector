...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetMasterPlansBySupplementalFieldParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetMasterPlansBySupplementalField {
	private static final Logger logger = LoggerFactory.getLogger(GetMasterPlansBySupplementalField.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Master Plans By Supplemental Field")
	@MediaType(value = "application/json")
	@Summary("This operation Use this API to return master plans associated with a specific value for a supplemental object field.")
	public void getMasterPlansBySupplementalField(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetMasterPlansBySupplementalFieldParam ar,
		...
		String apiName = "get_master_plans_by_supp_field_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetMasterPlansBySupplementalFieldParam ar) {
