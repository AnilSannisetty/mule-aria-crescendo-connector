...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SetExternalObjectIdParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class SetExternalObjectId {
	private static final Logger logger = LoggerFactory.getLogger(SetExternalObjectId.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Set External Object ID")
	@MediaType(value = "application/json")
	@Summary("This operation sets an external system ID for an internal Aria data object")
	public void setExternalObjectIdParam(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SetExternalObjectIdParam ar,
		...
		String apiName = "set_external_object_id_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SetExternalObjectIdParam ar) {
