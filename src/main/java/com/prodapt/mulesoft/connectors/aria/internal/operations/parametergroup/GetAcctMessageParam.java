...
public class  GetAcctMessageParam {
	
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns the body of a particular email message sent to a specified account holder.")
	@Optional(defaultValue = "get_acct_message_m")
