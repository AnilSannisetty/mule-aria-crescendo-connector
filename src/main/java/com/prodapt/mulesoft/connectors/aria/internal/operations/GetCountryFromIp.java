...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetCountryFromIpParam;
...
public class GetCountryFromIp {
	...
	@DisplayName("CRUD:Get Country from IP")
	@MediaType(value = "application/json")
	@Summary("Returns the county of origin for a specified IP address.")
	public void getCountryFromIp(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetCountryFromIpParam ar,
		...
		String apiName = "get_country_from_ip_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetCountryFromIpParam ar) {
