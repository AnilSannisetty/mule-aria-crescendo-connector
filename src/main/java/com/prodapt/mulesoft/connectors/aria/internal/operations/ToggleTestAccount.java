...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ToggleTestAccountParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ToggleTestAccount {
	private static final Logger logger = LoggerFactory.getLogger(ToggleTestAccount.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Toggle Test Account")
	@MediaType(value = "application/json")
	@Summary("This operation changes a specified account from a live account to a test account or from a test account to a live account.")
	public void toggleTestAccount(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ToggleTestAccountParam ar,
		...
		String apiName = "toggle_test_account_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ToggleTestAccountParam ar) {
