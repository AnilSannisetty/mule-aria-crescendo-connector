...
public class GetAcctTaxExemptStatusParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get an account's tax exemption level (none, federal, state, or both federal and state).")
	@Optional(defaultValue = "get_acct_tax_exempt_status_m")
