...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetCashCreditsDetailsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetCashCreditsDetails{
	private static final Logger logger = LoggerFactory.getLogger(GetCashCreditsDetails.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Cash Credits Details")
	@MediaType(value = "application/json")
	@Summary("This operation returns the details of the cash credits on an account, or just for a given cash credit \"transaction_id\". This operation also returns the charge details on which the cash credit is applied.")
	public void getCashCreditsDetails(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetCashCreditsDetailsParam ar,
		...
		String apiName = "get_cash_credits_details_m";
