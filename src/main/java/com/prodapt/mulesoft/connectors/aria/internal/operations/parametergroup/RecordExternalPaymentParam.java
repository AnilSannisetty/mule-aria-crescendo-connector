...
public class RecordExternalPaymentParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that records a payment transaction for a payment collected from an account holder without using Aria.")
	@Optional(defaultValue = "record_external_payment_m")
