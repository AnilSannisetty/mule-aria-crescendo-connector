...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetCmDetailsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetCmDetails {
	private static final Logger logger = LoggerFactory.getLogger(GetCmDetails.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Credit Memo Details")
	@MediaType(value = "application/json")
	@Summary("This operation returns information about the specified credit memo.")
	public void getCmDetails(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetCmDetailsParam ar,
		...
		String apiName = "get_cm_details_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetCmDetailsParam ar) {
