...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetInvoiceDetailsParam;
...
public class GetInvoiceDetails {
	...
	public void getInvoiceDetails(@Config RestConfiguration rc, @Connection AriaConnection ac,
		...
		String apiName = "get_invoice_details_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetInvoiceDetailsParam ar) {
