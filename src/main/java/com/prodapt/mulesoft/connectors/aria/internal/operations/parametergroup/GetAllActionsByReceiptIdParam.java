...
public class GetAllActionsByReceiptIdParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns a list of actions associated with a particular combination of client receipt ID and account.")
	@Optional(defaultValue = "get_all_actions_by_receipt_id_m")
