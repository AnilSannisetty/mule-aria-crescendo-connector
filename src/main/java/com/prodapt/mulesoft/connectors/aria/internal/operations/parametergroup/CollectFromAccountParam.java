...
public class CollectFromAccountParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to collect a specified amount from a specified account holder using the electronic method of payment on file.")
	@Optional(defaultValue = "collect_from_account_m")
