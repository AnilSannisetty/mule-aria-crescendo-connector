...
public class ApplyCouponToAcctParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that assigns a coupon code to a specified account or master plan instance.")
	@Optional(defaultValue = "apply_coupon_to_acct_m")
