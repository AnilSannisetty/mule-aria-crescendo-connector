...
public class GetAufStatusParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get the upload statistics for a specified client usage file.")
	@Optional(defaultValue = "get_auf_status_m")
