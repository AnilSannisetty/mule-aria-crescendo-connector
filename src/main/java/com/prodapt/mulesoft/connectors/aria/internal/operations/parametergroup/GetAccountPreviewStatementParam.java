...
public class  GetAccountPreviewStatementParam {
	
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that generates account's preview statement based on provided master plan instance.")
	@Optional(defaultValue = "get_acct_preview_statement_m")
