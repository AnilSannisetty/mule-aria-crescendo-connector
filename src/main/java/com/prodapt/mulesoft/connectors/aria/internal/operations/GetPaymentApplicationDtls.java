...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetPaymentApplicationDtlsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetPaymentApplicationDtls {
	private static final Logger logger = LoggerFactory.getLogger(GetPaymentApplicationDtls.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Payment Application Details")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to return the list of invoices on which the payment has been applied. Also  it returns the invoice line item details related to the payment application.")
	public void getPaymentApplicationDtls(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetPaymentApplicationDtlsParam ar,
		...
		String apiName = "get_payment_application_dtls_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetPaymentApplicationDtlsParam ar) {
