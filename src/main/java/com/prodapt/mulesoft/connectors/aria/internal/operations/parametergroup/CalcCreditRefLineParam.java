...
public class CalcCreditRefLineParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that calculates credit reference over invoice line items in the past. Aria calculates this estimate based on the data recorded at the time of the transaction and does not resend it through a tax engine.")
	@Optional(defaultValue = "calc_credit_reference_line_m")
