...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ValidateAcctFraudScoringParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ValidateAcctFraudScoring {
	private static final Logger logger = LoggerFactory.getLogger(ValidateAcctFraudScoring.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Validate Account Fraud Scoring")
	@MediaType(value = "application/json")
	@Summary("This operation obtains a fraud score and/or a fraud filter response from a payment gateway based on your criteria specified in your payment gateway. "
			+ "Example: when an account holder tries to make a purchase, "
			+ "you can take your chosen action on the account if:\r\n"
			+ "\r\n"
			...
			+ "To use this API, you must have fraud functionality enabled and configured in your payment gateway. Contact your payment gateway "
			+ "representative for setup information and additional documentation.")
	public void validateAcctFraudScoring(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ValidateAcctFraudScoringParam ar,
		...
		String apiName = "validate_acct_fraud_scoring_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ValidateAcctFraudScoringParam ar) {
