...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctNsoInclusionListParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctNsoInclusionList {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctNsoInclusionList.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account NSO Inclusion List")
	@MediaType(value = "application/json")
	@Summary("This operation is used to provide all the Active NSOs that are eligible for purchase as one time order.")
	public void getAcctNsoInclusionList(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctNsoInclusionListParam ar,
		...
		String apiName = "get_acct_nso_inclusion_list_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctNsoInclusionListParam ar) {
