...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctGroupsByAcctParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctGroupsByAcct {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctGroupsByAcct.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Groups By Account")
	@MediaType(value = "application/json")
	@Summary("This operation returns the list of account groups to which an account belongs.")
	public void getAcctGroupsByAcct(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctGroupsByAcctParam ar,
		...
		String apiName = "get_acct_groups_by_acct_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctGroupsByAcctParam ar) {
