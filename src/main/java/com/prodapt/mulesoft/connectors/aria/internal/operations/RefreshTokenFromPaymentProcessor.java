...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.RefreshTokenFromPaymentProcessorParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class RefreshTokenFromPaymentProcessor {
	private static final Logger logger = LoggerFactory.getLogger(RefreshTokenFromPaymentProcessor.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Refresh Token From Payment Processor")
	@MediaType(value = "application/json")
	@Summary("This operation sends an already-tokenized credit card saved in Aria to the payment processor which generated that token to check for updated information.")
	public void refreshTokenFromPaymentProcessor(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") RefreshTokenFromPaymentProcessorParam ar,
		...
		String apiName = "refresh_token_from_pmt_processor_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, RefreshTokenFromPaymentProcessorParam ar) {
