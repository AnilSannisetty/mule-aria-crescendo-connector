...
public class SubscribeEventsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that subscribes a client to a specified group of event notifications.")
	@Optional(defaultValue = "subscribe_events_m")
