...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.CompareAgainstCCBlacklistParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class CompareAgainstCCBlacklist  {
	private static final Logger logger = LoggerFactory.getLogger(CompareAgainstCCBlacklist .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Compare Against CC Blacklist")
	@MediaType(value = "application/json")
	@Summary("This operation compares a card number provided against entries in the blacklist.")
			
	public void compareAgainstCCBlacklist(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") CompareAgainstCCBlacklistParam ar,
		...
		String apiName = "compare_against_cc_blacklist_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, CompareAgainstCCBlacklistParam ar) {
