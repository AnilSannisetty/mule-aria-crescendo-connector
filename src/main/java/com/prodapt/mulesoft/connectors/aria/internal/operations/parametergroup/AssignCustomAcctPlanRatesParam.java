...
public class AssignCustomAcctPlanRatesParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to assign custom account plan rates.")
	@Optional(defaultValue = "assign_custom_acct_plan_rates_m")
