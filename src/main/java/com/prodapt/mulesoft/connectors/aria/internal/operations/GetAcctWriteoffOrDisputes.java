...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctWriteoffOrDisputesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctWriteoffOrDisputes {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctWriteoffOrDisputes.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Writeoff Or Disputes")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to retrieve the write-offs and disputes made on the account or master plan instance.")
	public void getAcctWriteoffOrDisputes(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctWriteoffOrDisputesParam ar,
		...
		String apiName = "get_acct_writeoff_or_disputes_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctWriteoffOrDisputesParam ar) {
