...
public class AuthenticateCallerParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to to verify a client number and auth key combination.")
	@Optional(defaultValue = "authenticate_caller_m")
