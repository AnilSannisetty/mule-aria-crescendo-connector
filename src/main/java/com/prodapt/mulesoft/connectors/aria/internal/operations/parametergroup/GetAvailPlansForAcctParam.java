...
public class GetAvailPlansForAcctParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get a list of plans available for assignment on a particular account.")
	@Optional(defaultValue = "get_avail_plans_for_acct_m")
