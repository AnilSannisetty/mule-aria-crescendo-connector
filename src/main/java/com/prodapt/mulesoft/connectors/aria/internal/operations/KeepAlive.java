...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.KeepAliveParam;
...
public class KeepAlive {
	...
	@Summary("This operation is used to increase the given valid session's expiry time by the number of minutes pre-defined for the client.")
	public void keepAlive(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") KeepAliveParam ar,
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, KeepAliveParam ar) {
