...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetUnbilledUsageSummaryParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetUnbilledUsageSummary {
	private static final Logger logger = LoggerFactory.getLogger(GetUnbilledUsageSummary.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Unbilled Usage Summary")
	@MediaType(value = "application/json")
	@Summary("This operation returns all information related to summary value of unbilled usage on the account.")
	public void getUnbilledUsageSummary(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetUnbilledUsageSummaryParam ar,
		...
		String apiName = "get_unbilled_usage_summary_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetUnbilledUsageSummaryParam ar) {
