...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetSuppPlansBySuppFieldParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetSuppPlansBySuppField {
	private static final Logger logger = LoggerFactory.getLogger(GetSuppPlansBySuppField.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Supplemental Plans By Supplemental Field")
	@MediaType(value = "application/json")
	@Summary("This operation returns a list of supplemental plans associated with a specified value for a supplemental object field.")
	public void getSuppPlansBySuppField(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetSuppPlansBySuppFieldParam ar,
		...
		String apiName = "get_supp_plans_by_supp_field_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetSuppPlansBySuppFieldParam ar) {
