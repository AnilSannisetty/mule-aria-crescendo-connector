...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.CalcCreditRefLineParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class CalcCreditRefLine {
	private static final Logger logger = LoggerFactory.getLogger(CalcCreditRefLine.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Calculate Credit Reference Line")
	@MediaType(value = "application/json")
	@Summary("This operation calculates credit reference over invoice line items in the past. Aria calculates this estimate based on the data recorded at the time of the transaction and does not resend it through a tax engine. ")
	public void calcCreditRefLine(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") CalcCreditRefLineParam ar,
		...
		String apiName = "calc_credit_reference_line_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, CalcCreditRefLineParam ar) {
