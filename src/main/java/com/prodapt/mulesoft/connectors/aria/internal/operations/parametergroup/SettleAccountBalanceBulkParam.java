...
public class SettleAccountBalanceBulkParam {
	...
	@Summary("Aria API call that allows for the batch submission of multiple accounts to a payment processor for collection attempts on each account to settle their balances.")
