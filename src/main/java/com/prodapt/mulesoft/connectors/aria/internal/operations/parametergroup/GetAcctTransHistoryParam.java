...
public class GetAcctTransHistoryParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns a list of financial transactions associated with an account.")
	@Optional(defaultValue = "get_acct_trans_history_m")
