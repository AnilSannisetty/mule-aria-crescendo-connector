...
public class AcctPlanInstallCompleteParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to mark the installation as failed or successful, causing the master plan to be either terminated or activated accordingly.")
	@Optional(defaultValue = "acct_plan_install_complete_m")
