...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetClientPlansBasicParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetClientPlansBasic {
	private static final Logger logger = LoggerFactory.getLogger(GetClientPlansBasic.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Client Plans Basic")
	@MediaType(value = "application/json")
	@Summary("This operation returns a summary list of all plans associated with a client.")
	public void getClientPlansBasic(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetClientPlansBasicParam ar,
		...
		String apiName = "get_client_plans_basic_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetClientPlansBasicParam ar) {
