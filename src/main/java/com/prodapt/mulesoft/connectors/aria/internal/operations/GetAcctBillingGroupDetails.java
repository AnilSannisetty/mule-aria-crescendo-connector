...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctBillingGroupDetailsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctBillingGroupDetails{
	private static final Logger logger = LoggerFactory.getLogger(GetAcctBillingGroupDetails.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Billing Group Details")
	@MediaType(value = "application/json")
	@Summary("This operation can be used retrieve the details for a specified billing group, including the list of master plans associated with that billing group.")
	public void getAcctBillingGroupDetails(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctBillingGroupDetailsParam ar,
		...
		String apiName = "get_acct_billing_group_details_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac,
			GetAcctBillingGroupDetailsParam ar) {
