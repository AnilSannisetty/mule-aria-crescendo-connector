...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.BulkRecordUsageParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class BulkRecordUsage {
	private static final Logger logger = LoggerFactory.getLogger(BulkRecordUsage.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Bulk Record Usage")
	@MediaType(value = "application/json")
	@Summary("This operation creates bulk usage records for a specified client for inclusion in a future invoice. For performance reasons, this operation should not be used unless there are more than 100 records being inserted.")
	public void bulkRecordUsage(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") BulkRecordUsageParam ar,
		...
		String apiName = "bulk_record_usage_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, BulkRecordUsageParam ar) {
