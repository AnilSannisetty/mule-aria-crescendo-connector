...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyAcctInvoiceParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ModifyAcctInvoice {
	private static final Logger logger = LoggerFactory.getLogger(ModifyAcctInvoice.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Update Account Invoice")
	@MediaType(value = "application/json")
	@Summary("This operation is used to modify the custom status, and custom notes to an invoice.")
	public void modifyAcctInvoice(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ModifyAcctInvoiceParam ar,
		...
		String apiName = "update_acct_invoice_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyAcctInvoiceParam ar) {
