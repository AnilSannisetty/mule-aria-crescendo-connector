...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.CancelUnconsumedCreditParam;
...
public class CancelUnconsumedCredit {
	...
	public void cancelUnconsumedCredit(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") CancelUnconsumedCreditParam ar,
		...
		String apiName = "cancel_unconsumed_credit_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, CancelUnconsumedCreditParam ar) {
