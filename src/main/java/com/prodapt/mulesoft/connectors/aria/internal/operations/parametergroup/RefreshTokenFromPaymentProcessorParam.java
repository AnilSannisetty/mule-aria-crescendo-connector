...
public class RefreshTokenFromPaymentProcessorParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that sends an already-tokenized credit card saved in Aria to the payment processor which generated that token to check for updated information.")
	@Optional(defaultValue = "refresh_token_from_pmt_processor_m")
