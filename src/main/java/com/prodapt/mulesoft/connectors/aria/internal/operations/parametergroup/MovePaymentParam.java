...
public class MovePaymentParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to move a payment from one invoice line to another; this also unapplies a payment from one transaction and applies it to another transaction.")
	@Optional(defaultValue = "move_payment_m")
