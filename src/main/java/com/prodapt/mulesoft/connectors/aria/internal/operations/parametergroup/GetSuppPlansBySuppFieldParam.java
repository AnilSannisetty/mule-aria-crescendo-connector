...
public class GetSuppPlansBySuppFieldParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns a list of supplemental plans associated with a specified value for a supplemental object field.")
	@Optional(defaultValue = "get_supp_plans_by_supp_field_m")
