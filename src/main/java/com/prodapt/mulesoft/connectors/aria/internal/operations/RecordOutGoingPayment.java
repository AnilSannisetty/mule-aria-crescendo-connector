...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.RecordOutGoingPaymentParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class RecordOutGoingPayment {
	private static final Logger logger = LoggerFactory.getLogger(RecordOutGoingPayment.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Record Outgoing Payment")
	@MediaType(value = "application/json")
	@Summary("This operation is used to record remittance to net terms accounts.")
	public void recordOutGoingPayment(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") RecordOutGoingPaymentParam ar,
		...
		String apiName = "record_out_going_payment_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, RecordOutGoingPaymentParam ar) {
