...
public class SetREGUSSConfigParamsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to create a generic configuration set that can be used to customize the functionality of a registration or user self-service (USS) application.")
	@Optional(defaultValue = "set_reg_uss_config_params_m")
