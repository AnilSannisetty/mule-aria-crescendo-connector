...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyAcctPlanParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ModifyAcctPlan {
	...
	@Summary("This operation updates in the context of an account's plan instance that plan's rates, "
			...
			+ "plan instance fields, usage management tracking, and/or service location.")
	public void modifyAcctPlan(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ModifyAcctPlanParam ar,
		...
		String apiName = "update_acct_plan_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyAcctPlanParam ar) {
