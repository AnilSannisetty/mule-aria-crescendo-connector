...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.EditAcctPlanQueuedChangesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class EditAcctPlanQueuedChanges {
	private static final Logger logger = LoggerFactory.getLogger(EditAcctPlanQueuedChanges.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Edit Account Plan Queued Changes")
	@MediaType(value = "application/json")
	@Summary("This operation is used to modify all existing queued plan changes for an account.")
	public void editAcctPlanQueuedChanges(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") EditAcctPlanQueuedChangesParam ar,
		...
		String apiName = "edit_acct_plan_queued_changes_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, EditAcctPlanQueuedChangesParam ar) {
