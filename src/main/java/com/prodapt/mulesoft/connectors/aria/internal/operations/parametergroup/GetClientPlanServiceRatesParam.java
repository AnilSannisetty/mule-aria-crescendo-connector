...
public class GetClientPlanServiceRatesParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get information about the rates for a particular service in a specified plan.")
	@Optional(defaultValue = "get_client_plan_service_rates_m")
