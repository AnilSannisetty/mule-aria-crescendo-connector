...
public class GetCurrentSystemVersionParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns the current version number of the Aria platform.")
	@Optional(defaultValue = "get_current_system_version_m")
