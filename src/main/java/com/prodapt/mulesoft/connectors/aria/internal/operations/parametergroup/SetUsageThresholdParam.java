...
public class SetUsageThresholdParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to set the Billing-Period-To-Date or Month-To-Date unbilled usage threshold amount on the master plan instance for client level event notifications or master plan instance level event notifications.")
	@Optional(defaultValue = "set_usage_threshold_m")
