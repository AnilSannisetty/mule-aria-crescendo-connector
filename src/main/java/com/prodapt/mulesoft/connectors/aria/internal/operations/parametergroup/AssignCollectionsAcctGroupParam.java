...
public class AssignCollectionsAcctGroupParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to assign collections account group.")
	@Optional(defaultValue = "assign_collections_acct_group_m")
