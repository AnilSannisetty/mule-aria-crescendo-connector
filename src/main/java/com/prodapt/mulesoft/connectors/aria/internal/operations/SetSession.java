...
public class SetSession {
	private static final Logger logger = LoggerFactory.getLogger(SetSession.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Set Session")
	@MediaType(value = "application/json")
	@Summary("This operation starts an Aria session for a specified user ID. Within an Aria session, you can perform functions such as securely processing payment transactions or securely retrieving account information in registration or User Self Service applications.")
	public void setsession(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SetSessionParam ar,
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SetSessionParam ar) {
