...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetClientCountriesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetClientCountries{
	private static final Logger logger = LoggerFactory.getLogger(GetClientCountries.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Client Countries")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to return a list of countries and corresponding currencies assigned to a client.")
	public void getClientCountries(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetClientCountriesParam ar,
		...
		String apiName = "get_client_countries_m";
