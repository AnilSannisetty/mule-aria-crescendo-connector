...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.AssignCollectionsAcctGroupParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class AssignCollectionsAcctGroup {
	private static final Logger logger = LoggerFactory.getLogger(AssignCollectionsAcctGroup.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Assign Collections Account Group")
	@MediaType(value = "application/json")
	@Summary("This operation assigns a specified account to a collections account group.")
	public void assignCollectionsAcctGroup(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") AssignCollectionsAcctGroupParam ar,
		...
		String apiName = "assign_collections_acct_group_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, AssignCollectionsAcctGroupParam ar) {
