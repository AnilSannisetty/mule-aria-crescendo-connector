...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyAcctNotifyMethodParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ModifyAcctNotifyMethod {
	...
	@Summary("Sets the method by which invoices are sent to a specified account.")
	public void modifyAcctNotifyMethod(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ModifyAcctNotifyMethodParam ar,
		...
		String apiName = "update_acct_notify_method_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyAcctNotifyMethodParam ar) {
