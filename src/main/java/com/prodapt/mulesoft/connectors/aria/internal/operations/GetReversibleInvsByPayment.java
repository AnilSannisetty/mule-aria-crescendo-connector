...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetReversibleInvsByPaymentParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetReversibleInvsByPayment{
	private static final Logger logger = LoggerFactory.getLogger(GetReversibleInvsByPayment.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Reversible Invoices By Payment")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to return the list of invoice transactions that were fully or partially paid by a given payment.")
	public void getReversibleInvsByPayment(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetReversibleInvsByPaymentParam ar,
		...
		String apiName = "get_reversible_invs_by_payment_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac,
			GetReversibleInvsByPaymentParam ar) {
