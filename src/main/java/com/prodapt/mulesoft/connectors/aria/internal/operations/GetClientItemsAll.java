...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetClientItemsAllParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetClientItemsAll{
	private static final Logger logger = LoggerFactory.getLogger(GetClientItemsAll.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Client Items All")
	@MediaType(value = "application/json")
	@Summary("This operation returns a list of inventory items associated with a client. The information returned includes prices, services, images, supplemental fields, and classes associated with the items.")
	public void getClientItemsAll(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetClientItemsAllParam ar,
		...
		String apiName = "get_client_items_all_m";
