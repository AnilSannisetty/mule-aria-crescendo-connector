...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetPaypalAvsStatusParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetPaypalAvsStatus{
	private static final Logger logger = LoggerFactory.getLogger(GetPaypalAvsStatus.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Paypal AVS Status")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to retrieve the Paypal AVS status.")
	public void getPaypalAvsStatus(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetPaypalAvsStatusParam ar,
		...
		String apiName = "get_paypal_avs_status_m";
