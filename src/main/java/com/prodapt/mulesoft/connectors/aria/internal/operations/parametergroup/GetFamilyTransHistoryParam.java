...
public class GetFamilyTransHistoryParam {
	
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get the transaction history of parent and child accounts.")
	@Optional(defaultValue = "get_family_trans_history_m")
