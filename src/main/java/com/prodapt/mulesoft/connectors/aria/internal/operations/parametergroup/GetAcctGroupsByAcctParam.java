...
public class GetAcctGroupsByAcctParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get the list of account groups to which an account belongs.")
	@Optional(defaultValue = "get_acct_groups_by_acct_m")
