...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyInstanceContractParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ModifyInstanceContract {
	private static final Logger logger = LoggerFactory.getLogger(ModifyInstanceContract.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Modify Instance Contract")
	@MediaType(value = "application/json")
	@Summary("This operation modifies an existing multi plan instance contract for a specified account holder and one or more plan instances.")
	public void modifyInstanceContract(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ModifyInstanceContractParam ar,
		...
		String apiName = "modify_instance_contract_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyInstanceContractParam ar) {
