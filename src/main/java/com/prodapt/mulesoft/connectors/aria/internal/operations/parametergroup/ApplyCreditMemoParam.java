...
public class ApplyCreditMemoParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that applies credit memo line credits to invoice gross line amounts.")
	@Optional(defaultValue = "apply_cm_m")
