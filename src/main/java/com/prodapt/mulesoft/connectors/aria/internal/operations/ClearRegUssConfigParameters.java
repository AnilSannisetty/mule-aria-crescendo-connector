...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ClearRegUssConfigParametersParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ClearRegUssConfigParameters  {
	private static final Logger logger = LoggerFactory.getLogger(ClearRegUssParameters .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Clear Reg Uss Config Parameters")
	@MediaType(value = "application/json")
	@Summary("This operation removes all of the parameter name-value pairs in a specified configuration set created using the set_reg_uss_config_params API call.")
			
	public void clearRegUssConfigParameters(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ClearRegUssConfigParametersParam ar,
		...
		String apiName = "clear_reg_uss_config_params_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ClearRegUssConfigParametersParam ar) {
