...
public class UnsubscribeEventClassParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that unsubscribes a client from a specified event class.")
	@Optional(defaultValue = "unsubscribe_event_class_m")
