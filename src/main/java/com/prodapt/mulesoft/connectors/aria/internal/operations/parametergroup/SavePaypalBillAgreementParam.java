...
public class SavePaypalBillAgreementParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that confirms that a billing agreement has been accepted by the account user, and that PayPal is able to authorize a payment against that billing agreement.")
	@Optional(defaultValue = "save_paypal_bill_agreement_m")
