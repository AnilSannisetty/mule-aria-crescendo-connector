...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SetPaymentResponsibilityParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class SetPaymentResponsibility  {
	private static final Logger logger = LoggerFactory.getLogger(SetPaymentResponsibility .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Set Payment Responsibility")
	@MediaType(value = "application/json")
	@Summary("This operation specifies the master plan instance on a parent account that is responsible for paying the invoices associated with a master plan instance for a child account.")
			
	public void setPaymentResponsibility(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SetPaymentResponsibilityParam ar,
		...
		String apiName = "set_payment_responsibility_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SetPaymentResponsibilityParam ar) {
