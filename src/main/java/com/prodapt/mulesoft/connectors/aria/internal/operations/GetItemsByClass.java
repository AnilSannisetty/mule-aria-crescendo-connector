...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetItemsByClassParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetItemsByClass {
	private static final Logger logger = LoggerFactory.getLogger(GetItemsByClass.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Items By Class")
	@MediaType(value = "application/json")
	@Summary("This operation returns the items for a given class.")
	public void getItemsByClass(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetItemsByClassParam ar,
		...
		String apiName = "get_items_by_class_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetItemsByClassParam ar) {
