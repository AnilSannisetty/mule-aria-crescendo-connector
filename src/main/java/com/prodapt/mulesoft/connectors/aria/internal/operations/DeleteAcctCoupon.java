...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.DeleteAcctCouponParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class DeleteAcctCoupon {
	private static final Logger logger = LoggerFactory.getLogger(DeleteAcctCoupon.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Delete Account Coupon")
	@MediaType(value = "application/json")
	@Summary("This operation deletes the coupon from the account or master plan instance and cancels any unconsumed credits on the account or master plan instance associated with the coupon.")
	public void deleteAcctCoupon(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") DeleteAcctCouponParam ar,
		...
		String apiName = "delete_acct_coupon_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, DeleteAcctCouponParam ar) {
