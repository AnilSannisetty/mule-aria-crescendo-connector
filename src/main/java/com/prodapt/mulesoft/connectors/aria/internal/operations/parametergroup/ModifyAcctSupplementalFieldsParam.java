...
public class ModifyAcctSupplementalFieldsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to update or delete one or more supplemental fields and/or values associated with a specified account.")
	@Optional(defaultValue = "modify_acct_supp_fields_m")
