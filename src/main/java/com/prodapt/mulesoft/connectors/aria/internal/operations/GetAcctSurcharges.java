...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctSurchargesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctSurcharges {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctSurcharges.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Surcharges")
	@MediaType(value = "application/json")
	@Summary("This operation is used to return the details of surcharges assigned to the given account/Master Plan Instance.")
	public void getAcctSurchanges(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctSurchargesParam ar,
		...
		String apiName = "get_acct_surcharges_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctSurchargesParam ar) {
