...
public class UnsubscribeEventsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that unsubscribes a client from a group of specified event notifications.")
	@Optional(defaultValue = "unsubscribe_events_m")
