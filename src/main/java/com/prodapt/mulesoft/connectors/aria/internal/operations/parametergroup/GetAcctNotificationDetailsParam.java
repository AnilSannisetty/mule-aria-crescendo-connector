...
public class GetAcctNotificationDetailsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get the notification details associated with a specified account.")
	@Optional(defaultValue = "get_acct_notification_details_m")
