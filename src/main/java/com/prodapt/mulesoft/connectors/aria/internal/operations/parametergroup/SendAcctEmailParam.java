...
public class  SendAcctEmailParam {
	
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that sends a specified message type to a particular account holder identified by a user ID.")
	@Optional(defaultValue = "send_acct_email_m")
