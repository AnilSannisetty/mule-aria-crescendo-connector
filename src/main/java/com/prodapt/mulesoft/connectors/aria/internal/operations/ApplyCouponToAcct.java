...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ApplyCouponToAcctParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ApplyCouponToAcct {
	private static final Logger logger = LoggerFactory.getLogger(ApplyCouponToAcct.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Apply Coupon To Account")
	@MediaType(value = "application/json")
	@Summary("This operation assigns a coupon code to a specified account or master plan instance. The appropriate service credits will then be applied to the account or master plan instance based on the credit template associated with the coupon code.")
	public void applyCouponToAcct(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ApplyCouponToAcctParam ar,
		...
		String apiName = "apply_coupon_to_acct_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ApplyCouponToAcctParam ar) {
