...
public class GetEmailTemplatesParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get the list of email templates associated with a client.")
	@Optional(defaultValue = "get_email_templates_m")
