...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctNoFromUserIdParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctNoFromUserId {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctNoFromUserId.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Number From User ID")
	@MediaType(value = "application/json")
	@Summary("This operation returns the account number associated with a specified user ID.")
	public void getAcctNoFromUserId(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctNoFromUserIdParam ar,
		...
		String apiName = "get_acct_no_from_user_id_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctNoFromUserIdParam ar) {
