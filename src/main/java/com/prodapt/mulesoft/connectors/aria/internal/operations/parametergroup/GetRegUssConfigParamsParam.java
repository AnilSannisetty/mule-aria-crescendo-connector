...
public class GetRegUssConfigParamsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get registration USS configuration params.")
	@Optional(defaultValue = "get_reg_uss_config_params_m")
