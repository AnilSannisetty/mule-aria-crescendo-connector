...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.AssignFunctionalAcctGroupParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class AssignFunctionalAcctGroup {
	private static final Logger logger = LoggerFactory.getLogger(AssignFunctionalAcctGroup.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Assign Functional Account Group")
	@MediaType(value = "application/json")
	@Summary("This operation assigns a specified account to a functional account group.")
	public void assignFunctionalAcctGroup(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") AssignFunctionalAcctGroupParam ar,
		...
		String apiName = "assign_functional_acct_group_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, AssignFunctionalAcctGroupParam ar) {
