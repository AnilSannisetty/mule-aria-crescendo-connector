...
public class SetREGUSSParamsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to create a configuration set that can be used to customize the functionality within a specified session of a registration or User Self Service application.")
	@Optional(defaultValue = "set_reg_uss_params_m")
