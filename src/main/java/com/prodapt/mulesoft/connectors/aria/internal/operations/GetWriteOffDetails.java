...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetWriteOffDetailsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetWriteOffDetails{
	private static final Logger logger = LoggerFactory.getLogger(GetWriteOffDetails.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Writeoff Details")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to return the writeoff details of an account.")
	public void getWriteOffDetails(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetWriteOffDetailsParam ar,
		...
		String apiName = "get_writeoff_details_m";
