...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ClientHasEventClassParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ClientHasEventClass  {
	private static final Logger logger = LoggerFactory.getLogger(ClientHasEventClass .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Client Has Event Class")
	@MediaType(value = "application/json")
	@Summary("This operation indicates whether a client is subscribed to the specified event notification class.")
			
	public void clientHasEventClass(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ClientHasEventClassParam ar,
		...
		String apiName = "client_has_event_class_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ClientHasEventClassParam ar) {
