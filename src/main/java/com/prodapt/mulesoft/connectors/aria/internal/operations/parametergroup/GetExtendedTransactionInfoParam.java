...
public class GetExtendedTransactionInfoParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get the list of optional transaction qualifiers submitted for the given transaction ID.")
	@Optional(defaultValue = "get_extended_transaction_info_m")
