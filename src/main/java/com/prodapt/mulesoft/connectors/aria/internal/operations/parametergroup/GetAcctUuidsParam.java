...
public class GetAcctUuidsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns the set of universally unique identifiers (UUIDs) for all credit card payment methods associated with an account.")
	@Optional(defaultValue = "get_acct_uuids_m")
