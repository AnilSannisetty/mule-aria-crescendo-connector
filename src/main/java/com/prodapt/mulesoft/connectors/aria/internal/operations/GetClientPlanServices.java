...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetClientPlanServicesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetClientPlanServices {
	private static final Logger logger = LoggerFactory.getLogger(GetClientPlanServices.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Client Plan Services")
	@MediaType(value = "application/json")
	@Summary("This operation returns information for all services in a specified plan.")
	public void getClientPlanServices(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetClientPlanServicesParam ar,
		...
		String apiName = "get_client_plan_services_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetClientPlanServicesParam ar) {
