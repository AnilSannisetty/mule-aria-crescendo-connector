...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAvailPlansForAcctAllParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAvailPlansForAcctAll {
	private static final Logger logger = LoggerFactory.getLogger(GetAvailPlansForAcctAll.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Available Plans For Account All")
	@MediaType(value = "application/json")
	@Summary("Use this operation to return a list of all plan, (including services, rate schedule details, and supplemental fields), available for assignment on a particular account. Available plans mean any master plans to create a new master plan instance(s), and any child plans (supplemental plans) of a master or supplemental plan that are available for assignment on the plan instances referred to as parent_plan_instance_no in the output array for this operation.")
	public void getAvailPlansForAcctAll(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAvailPlansForAcctAllParam ar,
		...
		String apiName = "get_avail_plans_for_acct_all_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAvailPlansForAcctAllParam ar) {
