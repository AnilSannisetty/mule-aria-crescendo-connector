...
public class GetAcctPlanHistoryParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns a list of plan changes (including assignments, replacements, status changes, etc.) for the specified account.")
	@Optional(defaultValue = "get_acct_plan_history_m")
