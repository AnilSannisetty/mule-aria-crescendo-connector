...
public class ModifyAcctNotifyMethodParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that sets the method by which invoices are sent to a specified account.")
	@Optional(defaultValue = "update_acct_notify_method_m")
