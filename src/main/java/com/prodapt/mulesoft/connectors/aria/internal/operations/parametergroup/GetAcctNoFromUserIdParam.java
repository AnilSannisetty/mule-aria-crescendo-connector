...
public class GetAcctNoFromUserIdParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get the account number associated with a specified user ID.")
	@Optional(defaultValue = "get_acct_no_from_user_id_m")
