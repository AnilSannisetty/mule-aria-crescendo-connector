...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctPlanNotifyMethodParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctPlanNotifyMethod {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctPlanNotifyMethod.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Plan Notify Method")
	@MediaType(value = "application/json")
	@Summary("This operation is used to return the method by which statements are sent for a specified plan instance, or billing group for a given account.")
	public void getAcctPlanNotifyMethod(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctPlanNotifyMethodParam ar,
		...
		String apiName = "get_acct_plan_notify_method_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctPlanNotifyMethodParam ar) {
