...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetWebReplacementValsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetWebReplacementVals {
	private static final Logger logger = LoggerFactory.getLogger(GetWebReplacementVals.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Web Replacement Values")
	@MediaType(value = "application/json")
	@Summary("This operation is used to return an array of values for an array of input web replacement strings.")
	public void getWebReplacementVals(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetWebReplacementValsParam ar,
		...
		String apiName = "get_web_replacement_vals_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetWebReplacementValsParam ar) {
