...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ReplaceREGUSSConfigParamsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ReplaceREGUSSConfigParams {
	private static final Logger logger = LoggerFactory.getLogger(ReplaceREGUSSConfigParams.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Replace Registration USS Configuration Parameters")
	@MediaType(value = "application/json")
	@Summary("This operation replaces the parameter name-value pairs in a particular configuration set with a specified set of new parameter name-value pairs.")
	public void replaceREGUSSConfigParams(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ReplaceREGUSSConfigParamsParam ar,
		...
		String apiName = "replace_reg_uss_config_params_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ReplaceREGUSSConfigParamsParam ar) {
