...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetStatementContentParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetStatementContent {
	private static final Logger logger = LoggerFactory.getLogger(GetStatementContent.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Statement Content")
	@MediaType(value = "application/json")
	@Summary("This operation returns the contents of a particular statement associated with a specified account.")
	public void getStatementContent(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetStatementContentParam ar,
		...
		String apiName = "get_statement_content_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetStatementContentParam ar) {
