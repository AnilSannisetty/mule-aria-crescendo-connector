...
public class GetCcVelocityInfoParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("For a card number provided, this Aria API call retrieves information related to collection attempts, authorizations, and primary / backup payment method updates to support velocity analysis.")
	@Optional(defaultValue = "get_cc_velocity_info_m")
