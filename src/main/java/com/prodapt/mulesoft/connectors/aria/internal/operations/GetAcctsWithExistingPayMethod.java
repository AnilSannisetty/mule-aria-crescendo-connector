...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctsWithExistingPayMethodParam;
...
public class GetAcctsWithExistingPayMethod {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctsWithExistingPayMethod.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Accounts With Existing Pay Method")
	@MediaType(value = "application/json")
	@Summary("For the given input specified electronic form of payment (credit card number, checking account number, etc.) this operation will return list of acct_nos on file that already have that form of payment assigned to them.")
	public void getAcctsWithExistingPayMethod(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctsWithExistingPayMethodParam ar,
		...
		String apiName = "get_accts_with_existing_pay_method_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctsWithExistingPayMethodParam ar) {
