...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyAcctPlanUnitInstancesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ModifyAcctPlanUnitInstances {
	private static final Logger logger = LoggerFactory.getLogger(ModifyAcctPlanUnitInstances.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Modify Account Plan Unit Instances")
	@MediaType(value = "application/json")
	@Summary("This operation is used  assign a new Plan Unit Instance to a specified plan, or to remove a Plan Unit Instance from a specified plan.")
	public void modifyAcctPlanUnitInstances(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ModifyAcctPlanUnitInstancesParam ar,
		...
		String apiName = "modify_acct_plan_unit_instances_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyAcctPlanUnitInstancesParam ar) {
