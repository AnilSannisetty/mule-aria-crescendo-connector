...
public class  SetAcctNotifyTemplateGroupParam {
	
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to assign or de_assign notification template group at the account level.")
	@Optional(defaultValue = "set_acct_notify_tmplt_grp_m")
