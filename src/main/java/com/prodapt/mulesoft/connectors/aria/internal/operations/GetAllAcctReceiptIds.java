...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAllAcctReceiptIdsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAllAcctReceiptIds {
	private static final Logger logger = LoggerFactory.getLogger(GetAllAcctReceiptIds.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get All Account Receipt IDs")
	@MediaType(value = "application/json")
	@Summary("This operation returns a list of all client receipt IDs associated with a specified account.")
	public void getAllAcctReceiptIds(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAllAcctReceiptIdsParam ar,
		...
		String apiName = "get_all_acct_receipt_ids_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAllAcctReceiptIdsParam ar) {
