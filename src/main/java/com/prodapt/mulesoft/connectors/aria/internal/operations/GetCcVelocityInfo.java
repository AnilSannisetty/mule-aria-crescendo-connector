...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetCcVelocityInfoParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetCcVelocityInfo {
	private static final Logger logger = LoggerFactory.getLogger(GetCcVelocityInfo.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get CC Velocity Info")
	@MediaType(value = "application/json")
	@Summary("For a card number provided, this operation retrieves information related to collection attempts, authorizations, and primary / backup payment method updates to support velocity analysis. Velocity data can be requested for a specific date range.")
	public void getCcVelocityInfo(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetCcVelocityInfoParam ar,
		...
		String apiName = "get_cc_velocity_info_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetCcVelocityInfoParam ar) {
