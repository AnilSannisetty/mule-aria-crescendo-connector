...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GenRbParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GenRb {
	private static final Logger logger = LoggerFactory.getLogger(GenRb.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Generate RB")
	@MediaType(value = "application/json")
	@Summary("This operation executes the rebill process against the specified invoice. It creates a credit memo to offset the charges in the original invoice. Then it creates a new rebill invoice using the changes specified in the rb_line_items array.")
	public void genRb(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GenRbParam ar,
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GenRbParam ar) {
