...
public class GetAcctPlansParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns the details of the master and supplemental plans assigned to a specified account.")
	@Optional(defaultValue = "get_acct_plans_m")
