...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetClientItemsBasicParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetClientItemsBasic{
	private static final Logger logger = LoggerFactory.getLogger(GetClientItemsBasic.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Client Items Basic")
	@MediaType(value = "application/json")
	@Summary("This operation returns a list of inventory items associated with a client.")
	public void getClientItemsBasic(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetClientItemsBasicParam ar,
		...
		String apiName = "get_client_items_basic_m";
