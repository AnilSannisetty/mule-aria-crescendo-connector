...
public class GetCreditDetailsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns specific service credit, or cash credit details for an account, or master plan instance.")
	@Optional(defaultValue = "get_credit_details_m")
