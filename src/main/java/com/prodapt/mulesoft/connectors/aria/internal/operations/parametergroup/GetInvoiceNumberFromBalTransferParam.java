...
public class GetInvoiceNumberFromBalTransferParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to return the invoice number associated with a specified balance transfer and master plan instance.")
	@Optional(defaultValue = "get_inv_no_from_bal_xfer_m")
