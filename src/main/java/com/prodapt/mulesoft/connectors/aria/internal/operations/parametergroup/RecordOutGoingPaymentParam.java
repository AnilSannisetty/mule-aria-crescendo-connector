...
public class RecordOutGoingPaymentParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to record remittance to net terms accounts.")
	@Optional(defaultValue = "record_out_going_payment_m")
