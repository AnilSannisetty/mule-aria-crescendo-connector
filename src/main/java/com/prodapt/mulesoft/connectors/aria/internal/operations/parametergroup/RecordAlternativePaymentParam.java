...
public class RecordAlternativePaymentParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to record a payment transaction for a payment collected from an account holder without using Aria.")
	@Optional(defaultValue = "record_alternative_payment_m")
