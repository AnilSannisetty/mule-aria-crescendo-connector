...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.AcctPlanInstallCompleteParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class AcctPlanInstallComplete {
	private static final Logger logger = LoggerFactory.getLogger(AcctPlanInstallComplete.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Account Plan Install Complete")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to mark the installation as failed or successful for accounts with master plans in the pending installation status, causing the master plan to be either terminated or activated accordingly.")
	public void acctPlanInstallComplete(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") AcctPlanInstallCompleteParam ar,
		...
		String apiName = "acct_plan_install_complete_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, AcctPlanInstallCompleteParam ar) {
