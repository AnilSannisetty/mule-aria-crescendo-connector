...
public class GetAllClientReceiptIdsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns a list of all client receipt IDs entered as input parameters for any API call to Aria.")
	@Optional(defaultValue = "get_all_client_receipt_ids_m")
