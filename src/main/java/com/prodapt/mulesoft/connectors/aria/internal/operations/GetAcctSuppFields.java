...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctSuppFieldsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctSuppFields {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctSuppFields.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Supplemental Fields")
	@MediaType(value = "application/json")
	@Summary("This operation returns a list of supplemental field names and values associated with an account.")
	public void getAcctSuppFields(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctSuppFieldsParam ar,
		...
		String apiName = "get_acct_supp_fields_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctSuppFieldsParam ar) {
