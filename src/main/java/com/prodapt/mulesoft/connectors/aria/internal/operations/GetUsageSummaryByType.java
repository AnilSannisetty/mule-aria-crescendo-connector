...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetUsageSummaryByTypeParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetUsageSummaryByType {
	private static final Logger logger = LoggerFactory.getLogger(GetUsageSummaryByType.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Usage Summary By Type")
	@MediaType(value = "application/json")
	@Summary("This operation returns the usage records associated with a specified account for a particular date range.")
	public void getUsageSummaryByType(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetUsageSummaryByTypeParam ar,
		...
		String apiName = "get_usage_summary_by_type_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetUsageSummaryByTypeParam ar) {
