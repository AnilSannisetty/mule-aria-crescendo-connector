...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetChildAcctsParam;
...
public class GetChildAccts {
	...
	@DisplayName("CRUD:Get Child Accounts")
	@MediaType(value = "application/json")
	@Summary("Returns all child account numbers associated with a specified parent account number.")
	public void getChildAccts(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetChildAcctsParam ar,
		...
		String apiName = "get_child_accts_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetChildAcctsParam ar) {
