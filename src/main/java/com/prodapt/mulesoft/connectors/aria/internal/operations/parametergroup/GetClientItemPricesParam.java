...
public class GetClientItemPricesParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns a list of prices for inventory item.")
	@Optional(defaultValue = "get_client_item_prices_m")
