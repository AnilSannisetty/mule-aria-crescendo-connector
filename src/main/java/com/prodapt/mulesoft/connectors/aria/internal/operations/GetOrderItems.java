...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetOrderItemsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetOrderItems {
	private static final Logger logger = LoggerFactory.getLogger(GetOrderItems.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Order Items")
	@MediaType(value = "application/json")
	@Summary("This operation returns information about the items in a particular order associated with a specified account.")
	public void getOrderItems(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetOrderItemsParam ar,
		...
		String apiName = "get_order_items_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetOrderItemsParam ar) {
