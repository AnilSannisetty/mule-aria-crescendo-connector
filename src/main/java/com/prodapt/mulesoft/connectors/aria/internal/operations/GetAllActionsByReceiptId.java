...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAllActionsByReceiptIdParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAllActionsByReceiptId {
	private static final Logger logger = LoggerFactory.getLogger(GetAllActionsByReceiptId.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get All Actions By Receipt ID")
	@MediaType(value = "application/json")
	@Summary("This operation returns a list of actions associated with a particular combination of client receipt ID and account.")
	public void getAllActionsByReceiptId(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAllActionsByReceiptIdParam ar,
		...
		String apiName = "get_all_actions_by_receipt_id_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAllActionsByReceiptIdParam ar) {
