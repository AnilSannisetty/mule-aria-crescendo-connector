...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetInstanceContractParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetInstanceContract {
	private static final Logger logger = LoggerFactory.getLogger(GetInstanceContract.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Instance Contract")
	@MediaType(value = "application/json")
	@Summary("This operation returns a multi-plan instance contract currently associated with a specified account.")
	public void getInstanceContract(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetInstanceContractParam ar,
		...
		String apiName = "get_instance_contract_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetInstanceContractParam ar) {
