...
public class GetAllAcctContractsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get an array of contracts associated with the given account, as well as contract details.")
	@Optional(defaultValue = "get_all_acct_contracts_m")
