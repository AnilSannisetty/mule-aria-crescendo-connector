...
public class ApplyCashCreditParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to apply a cash credit to an account, account-level charge, invoice, or invoice charge.")
	@Optional(defaultValue = "apply_cash_credit_m")
