...
public class GetClientItemImagesParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns all images associated with a given inventory item.")
	@Optional(defaultValue = "get_client_item_images_m")
