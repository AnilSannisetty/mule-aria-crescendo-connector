...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetRegUssParamsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetRegUssParams {
	private static final Logger logger = LoggerFactory.getLogger(GetRegUssParams.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Registration USS Parameters")
	@MediaType(value = "application/json")
	@Summary("This operation returns the parameter name-value pairs for a specified session ID.")
	public void getRegUssParams(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetRegUssParamsParam ar,
		...
		String apiName = "get_reg_uss_params_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetRegUssParamsParam ar) {
