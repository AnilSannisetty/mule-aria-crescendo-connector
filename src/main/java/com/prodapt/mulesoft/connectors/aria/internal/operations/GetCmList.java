...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetCmListParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetCmList {
	private static final Logger logger = LoggerFactory.getLogger(GetCmList.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Credit Memo List")
	@MediaType(value = "application/json")
	@Summary("Use this operation to return information on all credit memos associated to an account.")
	public void getCmList(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetCmListParam ar,
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetCmListParam ar) {
