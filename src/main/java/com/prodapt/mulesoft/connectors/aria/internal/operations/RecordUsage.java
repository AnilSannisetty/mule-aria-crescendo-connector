...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.RecordUsageParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class RecordUsage {
	private static final Logger logger = LoggerFactory.getLogger(RecordUsage.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Record Usage")
	@MediaType(value = "application/json")
	@Summary("This operation creates a usage record for a specified account for inclusion in a future invoice.")
	public void recordUsage(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") RecordUsageParam ar,
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, RecordUsageParam ar) {
