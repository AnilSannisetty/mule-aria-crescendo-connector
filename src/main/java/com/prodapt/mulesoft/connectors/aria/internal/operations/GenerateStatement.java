...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GenerateStatementParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GenerateStatement  {
	private static final Logger logger = LoggerFactory.getLogger(GenerateStatement .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Generate Statement")
	@MediaType(value = "application/json")
	@Summary("This operation generates a statement based on a master plan instance on the account.")
			
	public void generateStatement(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GenerateStatementParam ar,
		...
		String apiName = "gen_statement_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GenerateStatementParam ar) {
