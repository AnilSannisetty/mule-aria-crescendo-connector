...
public class GetMasterPlansBySupplementalFieldParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to return the master plans associated with a specific value for a supplemental object field.")
	@Optional(defaultValue = "get_master_plans_by_supp_field_m")
