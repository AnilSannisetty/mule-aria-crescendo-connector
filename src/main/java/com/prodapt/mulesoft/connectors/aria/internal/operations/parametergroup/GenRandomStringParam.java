...
public class GenRandomStringParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that generates a random string of letters and/or numbers.")
	@Optional(defaultValue = "gen_random_string_m")
