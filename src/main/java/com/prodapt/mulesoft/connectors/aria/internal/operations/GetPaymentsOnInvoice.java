...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetPaymentsOnInvoiceParam;
...
public class GetPaymentsOnInvoice {
	...
	public void getPaymentsOnInvoice(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetPaymentsOnInvoiceParam ar,
		...
		String apiName = "get_payments_on_invoice_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetPaymentsOnInvoiceParam ar) {
