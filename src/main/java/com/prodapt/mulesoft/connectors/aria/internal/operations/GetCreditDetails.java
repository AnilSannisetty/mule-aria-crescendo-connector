...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetCreditDetailsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetCreditDetails {
	private static final Logger logger = LoggerFactory.getLogger(GetCreditDetails.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Credit Details")
	@MediaType(value = "application/json")
	@Summary("This operation returns specific service credit, or cash credit details for an account, or master plan instance.")
	public void getCreditDetails(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetCreditDetailsParam ar,
		...
		String apiName = "get_credit_details_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetCreditDetailsParam ar) {
