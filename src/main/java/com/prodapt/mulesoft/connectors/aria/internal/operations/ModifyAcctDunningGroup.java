...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyAcctDunningGroupParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ModifyAcctDunningGroup {
	...
	public void modifyDunningGroup(@Config RestConfiguration rc, @Connection AriaConnection ac,
		...
		String apiName = "update_acct_dunning_group_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyAcctDunningGroupParam ar) {
