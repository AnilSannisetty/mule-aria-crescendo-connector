...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctPaymentMethodsAndTermsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctPaymentMethodsAndTerms{
	private static final Logger logger = LoggerFactory.getLogger(GetAcctPaymentMethodsAndTerms.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Payment Methods And Terms")
	@MediaType(value = "application/json")
	@Summary("This operation returns a list of payment methods and payment terms present on the account. It can be filtered to include only payment methods or payment terms by using the \"payments_returned\" input.")
	public void getAcctPaymentMethodsAndTerms(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctPaymentMethodsAndTermsParam ar,
		...
		String apiName = "get_acct_payment_methods_and_terms_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac,
			GetAcctPaymentMethodsAndTermsParam ar) {
