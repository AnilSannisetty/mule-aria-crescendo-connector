...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.UserIDExistsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class UserIDExists  {
	private static final Logger logger = LoggerFactory.getLogger(UserIDExists .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("User ID Exists")
	@MediaType(value = "application/json")
	@Summary("This operation determines whether a specified user ID is already in use.")
			
	public void userIDExists(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") UserIDExistsParam ar,
		...
		String apiName = "userid_exists_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, UserIDExistsParam ar) {
