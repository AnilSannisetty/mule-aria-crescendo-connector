...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetPaymentApplicationsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetPaymentApplications {
	private static final Logger logger = LoggerFactory.getLogger(GetPaymentApplications.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Payment Applications")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to return a list of charge transactions against which a particular credit transaction has been applied for a specified account.")
	public void getPaymentApplications(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetPaymentApplicationsParam ar,
		...
		String apiName = "get_payment_applications_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac,
			GetPaymentApplicationsParam ar) {
