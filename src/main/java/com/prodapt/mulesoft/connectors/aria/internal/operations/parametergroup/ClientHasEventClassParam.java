...
public class  ClientHasEventClassParam  {
	
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to indicate whether a client is subscribed to the specified event notification class.")
	@Optional(defaultValue = "client_has_event_class_m")
