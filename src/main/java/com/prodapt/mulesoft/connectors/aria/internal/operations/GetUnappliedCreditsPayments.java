...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetUnappliedCreditsPaymentsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetUnappliedCreditsPayments{
	private static final Logger logger = LoggerFactory.getLogger(GetUnappliedCreditsPayments.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Unapplied Credits and Payments")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to retrieve the payments and cash credits that are unapplied for a given account.")
	public void getUnappliedCreditsPayments(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetUnappliedCreditsPaymentsParam ar,
		...
		String apiName = "get_unapplied_credits_payments_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac,
			GetUnappliedCreditsPaymentsParam ar) {
