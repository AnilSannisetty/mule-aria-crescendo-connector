...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctPlanQueuedChangesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctPlanQueuedChanges {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctPlanQueuedChanges.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Plan Queued Changes")
	@MediaType(value = "application/json")
	@Summary("This operation retrieves all queued plan changes for a given plan instance including plan assignments, removals, replacements and rollovers, as well as changes to plan units, plan instance status, and rate schedules for both master plans and supplemental plans.")
	public void getAcctPlanQueuedChanges(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctPlanQueuedChangesParam ar,
		...
		String apiName = "get_acct_plan_queued_changes_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctPlanQueuedChangesParam ar) {
