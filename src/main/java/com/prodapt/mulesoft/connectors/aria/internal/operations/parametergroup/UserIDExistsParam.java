...
public class  UserIDExistsParam {
	
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that determines whether a specified user ID is already in use.")
	@Optional(defaultValue = "userid_exists_m")
