...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctCreditsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctCredits {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctCredits.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Credits")
	@MediaType(value = "application/json")
	@Summary("This operation returns an array of all service and cash credits associated with the given account or all service credits associated with a master plan instance. In addition, this API also provides the option to limit number of records.")
	public void getAcctCredits(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctCreditsParam ar,
		...
		String apiName = "get_acct_credits_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctCreditsParam ar) {
