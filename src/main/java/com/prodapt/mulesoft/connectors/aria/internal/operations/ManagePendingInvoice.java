...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ManagePendingInvoiceParam;
...
public class ManagePendingInvoice {
	...
	public void managePendingInvoice(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ManagePendingInvoiceParam ar,
		...
		String apiName = "manage_pending_invoice_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ManagePendingInvoiceParam ar) {
