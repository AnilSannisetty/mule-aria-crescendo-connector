...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyAcctUniversalContractParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ModifyAcctUniversalContract {
	private static final Logger logger = LoggerFactory.getLogger(ModifyAcctUniversalContract.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Modify Account Universal Contract")
	@MediaType(value = "application/json")
	@Summary("This operation modifies a universal contract assigned to a specified account.")
	public void modifyAcctUniversalContract(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ModifyAcctUniversalContractParam ar,
		...
		String apiName = "modify_acct_universal_contract_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyAcctUniversalContractParam ar) {
