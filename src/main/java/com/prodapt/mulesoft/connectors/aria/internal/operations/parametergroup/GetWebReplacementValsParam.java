...
public class GetWebReplacementValsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns an array of values for an array of input web replacement strings.")
	@Optional(defaultValue = "get_web_replacement_vals_m")
