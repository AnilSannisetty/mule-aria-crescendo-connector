...
public class GetAcctPlansAllParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns the plan, service, and rate schedule data for all master and supplemental plans assigned to a specified account.")
	@Optional(defaultValue = "get_acct_plans_all_m")
