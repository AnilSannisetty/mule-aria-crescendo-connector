...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.CreateAcctUniversalContractParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class CreateAcctUniversalContract {
	private static final Logger logger = LoggerFactory.getLogger(CreateAcctUniversalContract.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Create Account Universal Contract")
	@MediaType(value = "application/json")
	@Summary("This operation is used to create a universal contract for a specified account holder. ")
	public void createAcctUniversalContract(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") CreateAcctUniversalContractParam ar,
		...
		String apiName = "create_acct_universal_contract_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, CreateAcctUniversalContractParam ar) {
