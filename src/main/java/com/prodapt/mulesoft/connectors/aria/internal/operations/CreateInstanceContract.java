...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.CreateInstanceContractParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class CreateInstanceContract {
	private static final Logger logger = LoggerFactory.getLogger(CreateInstanceContract.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Create Instance Contract")
	@MediaType(value = "application/json")
	@Summary("This operation is used to create a multi-plan contract for a specified account holder and specified list of plans.  ")
	public void createInstanceContract(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") CreateInstanceContractParam ar,
		...
		String apiName = "create_instance_contract_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, CreateInstanceContractParam ar) {
