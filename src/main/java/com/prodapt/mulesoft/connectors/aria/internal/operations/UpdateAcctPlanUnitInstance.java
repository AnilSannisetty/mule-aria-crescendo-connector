...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.UpdateAcctPlanUnitInstanceParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class UpdateAcctPlanUnitInstance {
	private static final Logger logger = LoggerFactory.getLogger(UpdateAcctPlanUnitInstance.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Update Account Plan Unit Instance")
	...
	public void modifyAcctPlanUnitInstance(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") UpdateAcctPlanUnitInstanceParam ar,
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, UpdateAcctPlanUnitInstanceParam ar) {
