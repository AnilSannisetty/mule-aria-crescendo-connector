...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.RemoveAcctPaymentMethodParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class RemoveAcctPaymentMethod {
	...
	public void removeAccountPaymentMethod(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") RemoveAcctPaymentMethodParam ar,
		...
		String apiName = "remove_acct_payment_method_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, RemoveAcctPaymentMethodParam ar) {
