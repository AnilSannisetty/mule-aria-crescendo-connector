...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetChildForItemClassParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetChildForItemClass{
	private static final Logger logger = LoggerFactory.getLogger(GetChildForItemClass.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Child For Item Class")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to return the immediate child classes for that client.")
	public void getChildForItemClass(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetChildForItemClassParam ar,
		...
		String apiName = "get_child_for_item_class_m";
