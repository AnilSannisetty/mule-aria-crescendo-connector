...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetTopLevelItemClassParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetTopLevelItemClass {
	private static final Logger logger = LoggerFactory.getLogger(GetTopLevelItemClass.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Top Level Item Class")
	@MediaType(value = "application/json")
	@Summary("This operation is used to returns all the parent classes for that client.")
	public void getTopLevelItemClass(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetTopLevelItemClassParam ar,
		...
		String apiName = "get_top_level_item_class_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetTopLevelItemClassParam ar) {
