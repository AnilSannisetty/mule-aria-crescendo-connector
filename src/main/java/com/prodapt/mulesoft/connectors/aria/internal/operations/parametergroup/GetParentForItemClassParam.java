...
public class GetParentForItemClassParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get the immediate parent classes for that client.")
	@Optional(defaultValue = "get_parent_for_item_class_m")
