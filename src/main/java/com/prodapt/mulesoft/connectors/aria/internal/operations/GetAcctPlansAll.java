...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctPlansAllParam;
...
public class GetAcctPlansAll {
	...
	@DisplayName("CRUD:Get All Account Plans")
	@MediaType(value = "application/json")
	@Summary("Returns the plan, service, and rate schedule data for all master and supplemental plans assigned to a specified account. ")
	public void getAcctPlansAll(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctPlansAllParam ar,
		...
		String apiName = "get_acct_plans_all_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctPlansAllParam ar) {
