...
public class GetInvoiceHistory {
	...
	@Summary("This operation returns the invoice history for a specified master plan instance. The call can return invoices for all billing dates or only invoices for a particular billing date range.")
