...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyAcctMultiPlansParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ModifyAcctMultiPlans {
	...
	public void modifyAcctMultiPlans(@Config RestConfiguration rc, @Connection AriaConnection ac,
		...
		String apiName = "update_acct_plan_multi_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyAcctMultiPlansParam ar) {
