...
public class  GenerateStatementParam {
	
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that generates a statement based on a master plan instance on the account.")
	@Optional(defaultValue = "gen_statement_m")
