...
public class SetAcctTaxExemptStatusParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that sets the tax exemption level for a specified account.")
	@Optional(defaultValue = "set_acct_tax_exempt_status_m")
