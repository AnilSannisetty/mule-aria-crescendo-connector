...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.RecordAlternativePaymentParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class RecordAlternativePayment {
	private static final Logger logger = LoggerFactory.getLogger(RecordAlternativePayment.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Record Alternative Payment")
	@MediaType(value = "application/json")
	@Summary("This operation records a payment transaction for a payment collected from an account holder without using Aria.")
	public void recordAlternativePayment(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") RecordAlternativePaymentParam ar,
		...
		String apiName = "record_alternative_payment_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, RecordAlternativePaymentParam ar) {
