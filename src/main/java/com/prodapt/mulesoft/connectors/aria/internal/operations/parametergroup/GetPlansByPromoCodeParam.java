...
public class GetPlansByPromoCodeParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns a summary list of plans associated with a specified promotion code.")
	@Optional(defaultValue = "get_plans_by_promo_code_m")
