...
public class GetUserIdHasOrderedSKUParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that indicates whether a user ID has ever ordered or paid for a specified inventory item (SKU).")
	@Optional(defaultValue = "get_userid_has_ordered_sku_m")
