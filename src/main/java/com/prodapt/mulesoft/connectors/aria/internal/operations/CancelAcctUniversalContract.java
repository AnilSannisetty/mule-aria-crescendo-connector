...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.CancelAcctUniversalContractParam;
...
public class CancelAcctUniversalContract {
	...
	public void cancelAcctUniversalContract(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") CancelAcctUniversalContractParam ar,
		...
		String apiName = "cancel_acct_universal_contract_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, CancelAcctUniversalContractParam ar) {
