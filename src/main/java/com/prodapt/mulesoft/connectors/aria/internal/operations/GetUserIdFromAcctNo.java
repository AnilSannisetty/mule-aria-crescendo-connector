...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetUserIdFromAcctNoParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetUserIdFromAcctNo {
	private static final Logger logger = LoggerFactory.getLogger(GetUserIdFromAcctNo.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get User ID From Account Number")
	@MediaType(value = "application/json")
	@Summary("This operation returns the user ID associated with a specified account number.")
	public void getUserIdFromAcctNo(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetUserIdFromAcctNoParam ar,
		...
		String apiName = "get_user_id_from_acct_no_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetUserIdFromAcctNoParam ar) {
