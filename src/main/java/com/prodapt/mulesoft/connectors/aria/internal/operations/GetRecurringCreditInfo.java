...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetRecurringCreditInfoParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetRecurringCreditInfo {
	private static final Logger logger = LoggerFactory.getLogger(GetRecurringCreditInfo.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Recurring Credit Information")
	@MediaType(value = "application/json")
	@Summary("This operation returns a list of recurring credits associated with a specified account or master plan instance.")
	public void getRecurringCreditInfo(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetRecurringCreditInfoParam ar,
		...
		String apiName = "get_recurring_credit_info_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetRecurringCreditInfoParam ar) {
