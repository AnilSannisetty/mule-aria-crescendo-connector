...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SetAcctNotifyOverrideParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class SetAcctNotifyOverride {
	private static final Logger logger = LoggerFactory.getLogger(SetAcctNotifyOverride.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Set Account Notify Override")
	@MediaType(value = "application/json")
	@Summary("This operation is used to assign or remove the alternate message template for the given template class.")
	public void setAcctNotifyOverride(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SetAcctNotifyOverrideParam ar,
		...
		String apiName = "set_acct_notify_override_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SetAcctNotifyOverrideParam ar) {
