...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetClientItemImagesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetClientItemImages{
	private static final Logger logger = LoggerFactory.getLogger(GetClientItemImages.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Client Item Images")
	@MediaType(value = "application/json")
	@Summary("This operation returns all images associated with a given inventory item.")
	public void getClientItemImages(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetClientItemImagesParam ar,
		...
		String apiName = "get_client_item_images_m";
