...
public class SetSessionAuthParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that authenticates a customer who logs into a User Self Service application with a user ID and password.")
	@Optional(defaultValue = "set_session_auth_m")
