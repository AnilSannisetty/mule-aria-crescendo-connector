...
import com.prodapt.mulesoft.connectors.aria.api.connection.MandatoryTlsParameterGroup;
import com.prodapt.mulesoft.connectors.aria.api.connection.TlsParameterGroup;
import com.prodapt.mulesoft.connectors.aria.api.proxy.HttpProxyConfig;
...
public class AriaConnectionProvider implements CachedConnectionProvider<AriaConnection>, Initialisable, Startable, Stoppable {
	...
	public int getResponeTimeout() {
		return responeTimeout;
	}

	public void setResponeTimeout(int responeTimeout) {
		this.responeTimeout = responeTimeout;
	}
	...
	public AriaConnection connect() throws ConnectionException {
		try
		{
			...
			return createConnection(baseURL, client_number, auth_key, getConfigName(), httpClient, toMultiMap((Collection) this.defaultQueryParams), toMultiMap ((Collection) this.defaultHeaders)) ;
		}
		catch(Exception e)
		{
	...
	public ConnectionValidationResult validate(AriaConnection connection) {
	  ...
	  protected AriaConnection createConnection(String baseURL, long client_number, String auth_key, String configName, HttpClient httpClient, MultiMap<String, String> defaultQueryParams, MultiMap<String, String> defaultHeaders) {
		    return new AriaConnection(getBaseURL(), client_number, auth_key , getConfigName(), httpClient, defaultQueryParams, defaultHeaders);
		  }
	...
	private void verifyConnectionsParameters() throws InitialisationException {
	  ...
	  private void configureTcpSocket(HttpClientConfiguration.Builder configuration) {
		    ...
		    if (this.connectionTimeout != null)
		      socketProperties.connectionTimeout(Integer.valueOf(asMillis(this.connectionTimeout, this.connectionTimeoutUnit))); 
