...
public class VoidCreditMemoParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that voids a previously created credit memo if the credit memo has not already been voided or it was not created due to an issue of a rebill on an invoice.")
	@Optional(defaultValue = "void_credit_memo_m")
