...
public class GetPaymentsOnInvoiceParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get payments applied against a given invoice.")
	@Optional(defaultValue = "get_payments_on_invoice_m")
