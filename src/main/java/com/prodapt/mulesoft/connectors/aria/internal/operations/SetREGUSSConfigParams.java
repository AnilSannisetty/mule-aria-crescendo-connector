...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SetREGUSSConfigParamsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class SetREGUSSConfigParams {
	private static final Logger logger = LoggerFactory.getLogger(SetREGUSSConfigParams.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Set Registration USS Configuration Parameters")
	@MediaType(value = "application/json")
	@Summary("This operation is used to create a generic configuration set that can be used to customize the functionality of a registration or user self-service (USS) application.")
	public void setRegUssConfigParams(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SetREGUSSConfigParamsParam ar,
		...
		String apiName = "set_reg_uss_config_params_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SetREGUSSConfigParamsParam ar) {
