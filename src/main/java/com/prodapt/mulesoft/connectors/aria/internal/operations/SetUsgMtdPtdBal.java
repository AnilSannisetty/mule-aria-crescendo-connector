...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SetUsgMtdPtdBalParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class SetUsgMtdPtdBal {
	private static final Logger logger = LoggerFactory.getLogger(SetUsgMtdPtdBal.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Set Usage Month-To-Date or Period-To-Date Balance")
	@MediaType(value = "application/json")
	@Summary("This operation resets the client or master plan instance Billing-Period-To-Date "
			+ "or Month-To-Date unbilled usage balance to zero")
	public void setUsgMtdPtdBal(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SetUsgMtdPtdBalParam ar,
		...
		String apiName = "set_usg_mtd_ptd_bal_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SetUsgMtdPtdBalParam ar) {
