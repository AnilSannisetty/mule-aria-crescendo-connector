...
public class GetAcctStatusHistoryParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get the history of modifications to an account's status.")
	@Optional(defaultValue = "get_acct_status_history_m")
