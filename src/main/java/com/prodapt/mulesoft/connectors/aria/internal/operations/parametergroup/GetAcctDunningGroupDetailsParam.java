...
public class GetAcctDunningGroupDetailsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that retreives the details for a specified dunning group, including the list of master plan instances associated with that dunning group.")
	@Optional(defaultValue = "get_acct_dunning_group_details_m")
