package com.prodapt.mulesoft.connectors.aria.internal.error.exception;
...
public class AriaException extends ModuleException implements ErrorMessageAwareException {
	...
	private final Message message;
	  ...
	  public AriaException(AriaErrorTypes error, Result<Object, HttpResponseAttributes> response) {
