...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.VoidTransactionParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class VoidTransaction {
	private static final Logger logger = LoggerFactory.getLogger(VoidTransaction.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Void Transaction")
	@MediaType(value = "application/json")
	@Summary("This operation voids a particular transaction associated with a specified account.")
	public void voidTransaction(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") VoidTransactionParam ar,
		...
		String apiName = "void_transaction_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, VoidTransactionParam ar) {
