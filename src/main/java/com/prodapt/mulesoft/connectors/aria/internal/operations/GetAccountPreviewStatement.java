...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAccountPreviewStatementParam;

import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAccountPreviewStatement {
	private static final Logger logger = LoggerFactory.getLogger(GetAccountPreviewStatement.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Preview Statement")
	@MediaType(value = "application/json")
	@Summary("This operation generates account's preview statement based on provided master plan instance.")
	public void getAccountPreviewStatement(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAccountPreviewStatementParam ar,
		...
		String apiName = "get_acct_preview_statement_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAccountPreviewStatementParam ar) {
