...
public class GetSuppPlansByPromoCodeParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns a summary list of supplemental plans associated with a specified promotion code.")
	@Optional(defaultValue = "get_supp_plans_by_promo_code_m")
