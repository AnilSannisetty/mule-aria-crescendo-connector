...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctServiceOutageCreditParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctServiceOutageCredit {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctServiceOutageCredit.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Service Outage Credit")
	@MediaType(value = "application/json")
	@Summary("This operation retrieves the service outage for an account or master plan instance.")
	public void getAcctServiceOutageCredit(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctServiceOutageCreditParam ar,
		...
		String apiName = "get_acct_service_outage_credit_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctServiceOutageCreditParam ar) {
