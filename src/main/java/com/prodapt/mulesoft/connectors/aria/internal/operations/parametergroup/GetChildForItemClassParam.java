...
public class GetChildForItemClassParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get the immediate child classes for that client.")
	@Optional(defaultValue = "get_child_for_item_class_m")
