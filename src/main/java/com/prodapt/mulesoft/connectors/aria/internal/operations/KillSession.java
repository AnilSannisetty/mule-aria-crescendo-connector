...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.KillSessionParam;
...
public class KillSession {
	...
	@Summary("This operation is used to end a customer's session in a registration or User Self Service application.")
	public void killSession(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") KillSessionParam ar,
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, KillSessionParam ar) {
