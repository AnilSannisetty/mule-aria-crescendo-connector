...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyAcctPlanStatusParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ModifyAcctPlanStatus {
	...
	public void modifyAcctPlanStatus(@Config RestConfiguration rc, @Connection AriaConnection ac,
		...
		String apiName = "update_acct_plan_status_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyAcctPlanStatusParam ar) {
