...
public class ModifyAcctUniversalContractParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to modify a universal contract assigned to a specified account.")
	@Optional(defaultValue = "modify_acct_universal_contract_m")
