...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetPlansByPromoCodeParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetPlansByPromoCode {
	private static final Logger logger = LoggerFactory.getLogger(GetPlansByPromoCode.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Plans By Promo Code")
	@MediaType(value = "application/json")
	@Summary("This operation returns a summary list of plans associated with a specified promotion code.")
	public void getPlansByPromoCode(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetPlansByPromoCodeParam ar,
		...
		String apiName = "get_plans_by_promo_code_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetPlansByPromoCodeParam ar) {
