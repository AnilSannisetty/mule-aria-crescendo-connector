...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetSuppFieldValuesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetSuppFieldValues {
	private static final Logger logger = LoggerFactory.getLogger(GetSuppFieldValues.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Supplemental Field Values")
	@MediaType(value = "application/json")
	@Summary("This operation returns the values for a particular supplemental field associated with a specified account.")
	public void getSuppFieldValues(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetSuppFieldValuesParam ar,
		...
		String apiName = "get_supp_field_values_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetSuppFieldValuesParam ar) {
