...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ApplyServiceCreditParam;
...
public class ApplyServiceCredit {
	...
	public void applyServiceCredit(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ApplyServiceCreditParam ar,
		...
		String apiName = "apply_service_credit_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ApplyServiceCreditParam ar) {
