...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctStatusHistoryParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctStatusHistory {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctStatusHistory.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Status History")
	@MediaType(value = "application/json")
	@Summary("This operation is used to return the history of modifications to an account's status.")
	public void getAcctStatusHistory(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctStatusHistoryParam ar,
		...
		String apiName = "get_acct_status_history_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctStatusHistoryParam ar) {
