...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.MovePaymentParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class MovePayment {
	private static final Logger logger = LoggerFactory.getLogger(MovePayment.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Move Payment")
	@MediaType(value = "application/json")
	@Summary("This operation moves a payment from one invoice line to another; this also unapplies a payment from one transaction and applies it to another transaction.")
	public void movePayment(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") MovePaymentParam ar,
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, MovePaymentParam ar) {
