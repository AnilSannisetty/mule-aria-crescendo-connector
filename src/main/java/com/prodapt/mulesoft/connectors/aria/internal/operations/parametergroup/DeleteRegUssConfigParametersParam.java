...
public class DeleteRegUssConfigParametersParam  {
	
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that removes the parameter name-value pairs in a specified configuration set created using the set_reg_uss_config_params call.")
	@Optional(defaultValue = "delete_reg_uss_config_params_m")
