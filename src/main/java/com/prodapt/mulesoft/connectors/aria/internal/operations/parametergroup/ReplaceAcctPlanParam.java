...
public class ReplaceAcctPlanParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to replace an existing master or supplemental plan with a new master or supplemental plan for a specified account.")
	@Optional(defaultValue = "replace_acct_plan_m")
