...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.VoidInvoiceParam;
...
public class VoidInvoice {
	...
	@Summary("Voids a given invoice object and all its associated transactions. Voiding an invoice is permanent and cannot be undone.")
	public void voidInvoice(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") VoidInvoiceParam ar,
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, VoidInvoiceParam ar) {
