...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetFamilyTransHistoryParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetFamilyTransHistory {
	private static final Logger logger = LoggerFactory.getLogger(GetFamilyTransHistory.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Family Transaction History")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to return the transaction history of parent and child accounts.")
	public void getFamilyTransHistory(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetFamilyTransHistoryParam ar,
		...
		String apiName = "get_family_trans_history_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetFamilyTransHistoryParam ar) {
