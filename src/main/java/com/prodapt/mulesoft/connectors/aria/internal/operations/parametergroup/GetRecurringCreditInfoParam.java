...
public class GetRecurringCreditInfoParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to retrieve a list of recurring credits associated with a specified account or master plan instance.")
	@Optional(defaultValue = "get_recurring_credit_info_m")
