...
public class GetAcctUniversalContractParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to return any universal contract currently associated with a specified account.")
	@Optional(defaultValue = "get_acct_universal_contract_m")
