...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ValidateSessionParam;
...
public class ValidateSession {
	...
	@Summary("This operation determines the validity of a specified session and the user with which a session ID is associated.")
	public void validateSession(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ValidateSessionParam ar,
		...
		String apiName = "validate_session_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ValidateSessionParam ar) {
