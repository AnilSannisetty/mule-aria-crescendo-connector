...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetInvoicesToWriteOffOrDisputeParam;
...
public class GetInvoicesToWriteoffOrDispute {
	...
	@DisplayName("CRUD:Get Invoices to Writeoff or Dispute")
	@MediaType(value = "application/json")
	@Summary("Use this to retrieve eligible invoices to write-off or dispute.")
	public void getInvoicesToWriteoffOrDispute(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetInvoicesToWriteOffOrDisputeParam ar,
		...
		String apiName = "get_invoices_to_writeoff_or_dispute_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetInvoicesToWriteOffOrDisputeParam ar) {
