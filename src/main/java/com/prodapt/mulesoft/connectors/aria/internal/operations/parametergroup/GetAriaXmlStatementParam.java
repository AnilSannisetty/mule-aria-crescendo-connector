...
public class GetAriaXmlStatementParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get the contents of a specific xml statement for an account, transaction history of parent, and child accounts.")
	@Optional(defaultValue = "get_aria_xml_statement_m")
