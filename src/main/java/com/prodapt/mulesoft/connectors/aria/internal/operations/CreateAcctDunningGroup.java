...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.CreateAcctDunningGroupParam;
...
public class CreateAcctDunningGroup {

	private static final Logger logger = LoggerFactory.getLogger(CreateAcctDunningGroup.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Create Account Dunning Group")
	@MediaType(value = "application/json")
	@Summary("This operation creates a new dunning group and optionally assigns the new dunning group to a plan instance.")
	public void createDunningGroup(@Config RestConfiguration rc, @Connection AriaConnection ac,
		...
		String apiName = "create_acct_dunning_group_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, CreateAcctDunningGroupParam ar) {
