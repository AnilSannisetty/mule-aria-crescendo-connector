...
public class GetAcctSuppFieldsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns a list of supplemental field names and values associated with an account.")
	@Optional(defaultValue = "get_acct_supp_fields_m")
