...
public class GetStatementForInvSizeParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns the number of characters in a statement associated with a specified account and invoice.")
	@Optional(defaultValue = "get_statement_for_inv_size_m")
