...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctUuidsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctUuids {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctUuids.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account UUIDs")
	@MediaType(value = "application/json")
	@Summary("This operation returns the set of universally unique identifiers (UUIDs) for all credit card payment methods associated with an account.")
	public void getAcctUuids(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctUuidsParam ar,
		...
		String apiName = "get_acct_uuids_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctUuidsParam ar) {
