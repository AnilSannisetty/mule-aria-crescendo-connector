...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetRegUssConfigParamsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetRegUssConfigParams {
	private static final Logger logger = LoggerFactory.getLogger(GetRegUssConfigParams.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Registration USS Configuration Parameters")
	@MediaType(value = "application/json")
	@Summary("This operation returns a configuration set that can be used to customize the global functionality of a registration or User Self Service application.")
	public void getRegUssConfigParams(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetRegUssConfigParamsParam ar,
		...
		String apiName = "get_reg_uss_config_params_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetRegUssConfigParamsParam ar) {
