...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetUserIdHasOrderedSKUParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetUserIdHasOrderedSKU {
	private static final Logger logger = LoggerFactory.getLogger(GetUserIdHasOrderedSKU.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get User ID Has Ordered SKU")
	@MediaType(value = "application/json")
	@Summary("This operation indicates whether a user ID has ever ordered or paid for a specified inventory item (SKU).")
	public void getUseridHasOrderedSku(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetUserIdHasOrderedSKUParam ar,
		...
		String apiName = "get_userid_has_ordered_sku_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetUserIdHasOrderedSKUParam ar) {
