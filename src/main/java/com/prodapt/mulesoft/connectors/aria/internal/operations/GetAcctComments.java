...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctCommentsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctComments {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctComments.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Comments")
	@MediaType(value = "application/json")
	@Summary("This operation returns the comments associated with a particular account for a specified date range.")
	public void getAcctComments(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctCommentsParam ar,
		...
		String apiName = "get_acct_comments_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctCommentsParam ar) {
