...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetSuppPlansByPromoCodeParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetSuppPlansByPromoCode {
	private static final Logger logger = LoggerFactory.getLogger(GetSuppPlansByPromoCode.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Supplemental Plans By Promo Code")
	@MediaType(value = "application/json")
	@Summary("This operation returns a summary list of supplemental plans associated with a specified promotion code.")
	public void getSuppPlansByPromoCode(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetSuppPlansByPromoCodeParam ar,
		...
		String apiName = "get_supp_plans_by_promo_code_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetSuppPlansByPromoCodeParam ar) {
