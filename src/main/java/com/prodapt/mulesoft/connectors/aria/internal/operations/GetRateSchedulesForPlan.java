...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetRateSchedulesForPlanParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetRateSchedulesForPlan {
	private static final Logger logger = LoggerFactory.getLogger(GetRateSchedulesForPlan.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Rate Schedules For Plan")
	@MediaType(value = "application/json")
	@Summary("This operation returns a list of rate schedules associated with a specified plan.")
	public void getRateSchedulesForPlan(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetRateSchedulesForPlanParam ar,
		...
		String apiName = "get_rate_schedules_for_plan_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetRateSchedulesForPlanParam ar) {
