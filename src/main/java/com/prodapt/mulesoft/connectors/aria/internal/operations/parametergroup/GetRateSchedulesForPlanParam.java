...
public class GetRateSchedulesForPlanParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get a list of rate schedules associated with a specified plan.")
	@Optional(defaultValue = "get_rate_schedules_for_plan_m ")
