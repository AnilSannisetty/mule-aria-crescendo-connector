...
public class GetStatementContentSizeParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns the number of characters in the given statement.")
	@Optional(defaultValue = "get_statement_content_size_m")
