...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetCurrentSystemVersionParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetCurrentSystemVersion {
	private static final Logger logger = LoggerFactory.getLogger(GetCurrentSystemVersion.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Current System Version")
	@MediaType(value = "application/json")
	@Summary("This operation returns the current version number of the Aria platform.")
	public void getCurrentSystemVersion(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetCurrentSystemVersionParam ar,
		...
		String apiName = "get_current_system_version_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetCurrentSystemVersionParam ar) {
