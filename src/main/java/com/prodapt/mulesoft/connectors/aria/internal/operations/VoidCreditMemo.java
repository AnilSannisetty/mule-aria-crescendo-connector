...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.VoidCreditMemoParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class VoidCreditMemo {
	private static final Logger logger = LoggerFactory.getLogger(VoidCreditMemo.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Void Credit Memo")
	@MediaType(value = "application/json")
	@Summary("This operation voids a previously created credit memo if the credit memo has not already been voided or it was not created due to an issue of a rebill on an invoice.")
	public void voidCreditMemo(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") VoidCreditMemoParam ar,
		...
		String apiName = "void_credit_memo_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, VoidCreditMemoParam ar) {
