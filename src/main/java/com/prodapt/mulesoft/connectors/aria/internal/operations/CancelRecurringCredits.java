...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.CancelRecurringCreditsParam;
...
public class CancelRecurringCredits {
	...
	public void cancelRecurringCredits(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") CancelRecurringCreditsParam ar,
		...
		String apiName = "cancel_recurring_credits_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, CancelRecurringCreditsParam ar) {
