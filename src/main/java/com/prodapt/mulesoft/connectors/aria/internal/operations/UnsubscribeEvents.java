...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.UnsubscribeEventsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class UnsubscribeEvents {
	private static final Logger logger = LoggerFactory.getLogger(UnsubscribeEvents.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Unsubscribe Events")
	@MediaType(value = "application/json")
	@Summary("This operation unsubscribes a client from a group of specified event notifications.")
	public void unsubscribeevents(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") UnsubscribeEventsParam ar,
		...
		String apiName = "unsubscribe_events_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, UnsubscribeEventsParam ar) {
