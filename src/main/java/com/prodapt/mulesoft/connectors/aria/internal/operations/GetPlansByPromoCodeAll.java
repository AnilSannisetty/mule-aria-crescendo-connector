...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetPlansByPromoCodeAllParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetPlansByPromoCodeAll {
	private static final Logger logger = LoggerFactory.getLogger(GetPlansByPromoCodeAll.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Plans By Promo Code All")
	@MediaType(value = "application/json")
	@Summary("This operation returns a detailed list of plans associated with a specified promotion code. The information returned includes the services and rate schedules associated with the plans.")
	public void getPlansByPromoCodeAll(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetPlansByPromoCodeAllParam ar,
		...
		String apiName = "get_plans_by_promo_code_all_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetPlansByPromoCodeAllParam ar) {
