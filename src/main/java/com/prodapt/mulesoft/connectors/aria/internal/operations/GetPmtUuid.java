...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetPmtUuidParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetPmtUuid {
	private static final Logger logger = LoggerFactory.getLogger(GetPmtUuid.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Payment UUID")
	@MediaType(value = "application/json")
	@Summary("This operation returns the universally unique identifier (UUID) for a credit card payment method.")
	public void getPmtUuid(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetPmtUuidParam ar,
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetPmtUuidParam ar) {
