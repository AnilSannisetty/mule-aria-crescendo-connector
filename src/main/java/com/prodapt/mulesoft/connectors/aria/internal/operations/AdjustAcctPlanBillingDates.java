...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.AdjustAcctPlanBillingDatesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class AdjustAcctPlanBillingDates {
	private static final Logger logger = LoggerFactory.getLogger(AdjustAcctPlanBillingDates.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Adjust Account Plan Billing Dates")
	@MediaType(value = "application/json")
	@Summary("This operation is used to adjust the billing date for a specified set of master plans under one or more accounts.")
	public void adjustAcctPlanBillingDates(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") AdjustAcctPlanBillingDatesParam ar,
		...
		String apiName = "adjust_acct_plan_billing_dates_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, AdjustAcctPlanBillingDatesParam ar) {
