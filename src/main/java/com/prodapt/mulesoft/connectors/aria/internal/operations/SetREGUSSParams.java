...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SetREGUSSParamsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class SetREGUSSParams {
	private static final Logger logger = LoggerFactory.getLogger(SetREGUSSParams.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Set Registration USS Parameters")
	@MediaType(value = "application/json")
	@Summary("This operation creates a configuration set that can be used to customize the functionality within a specified session of a registration or User Self Service application.")
	public void setRegUssParams(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SetREGUSSParamsParam ar,
		...
		String apiName = "set_reg_uss_params_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SetREGUSSParamsParam ar) {
