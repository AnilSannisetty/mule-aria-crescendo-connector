...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetInvoiceCMDetailsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetInvoiceCMDetails {
	...
	public void getInvoiceCMDetails(@Config RestConfiguration rc, @Connection AriaConnection ac,
		...
		String apiName = "get_invoice_cm_details_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetInvoiceCMDetailsParam ar) {
