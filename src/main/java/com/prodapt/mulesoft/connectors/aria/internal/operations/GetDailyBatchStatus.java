...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetDailyBatchStatusParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetDailyBatchStatus {
	private static final Logger logger = LoggerFactory.getLogger(GetDailyBatchStatus.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Daily Batch Status")
	@MediaType(value = "application/json")
	@Summary("This operation returns a string representing the current status of the Net Terms/Statement Status Mgr batch job for the given client and date.")
	public void getDailyBatchStatus(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetDailyBatchStatusParam ar,
		...
		String apiName = "get_daily_batch_status_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetDailyBatchStatusParam ar) {
