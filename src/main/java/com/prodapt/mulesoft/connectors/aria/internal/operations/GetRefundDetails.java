...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetRefundDetailsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetRefundDetails {
	private static final Logger logger = LoggerFactory.getLogger(GetRefundDetails.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("CRUD:Get Refund Details")
	@MediaType(value = "application/json")
	@Summary("Returns refund information, including invoice reversals, for a specified account.")
	public void getRefundDetails(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetRefundDetailsParam ar,
		...
		String apiName = "get_refund_details_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetRefundDetailsParam ar) {
