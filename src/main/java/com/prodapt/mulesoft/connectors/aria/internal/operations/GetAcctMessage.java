...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctMessageParam;

import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctMessage {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctMessage.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Message")
	@MediaType(value = "application/json")
	@Summary("This operation returns the body of a particular email message sent to a specified account holder.")
	public void getAcctMessage(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctMessageParam ar,
		...
		String apiName = "get_acct_message_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctMessageParam ar) {
