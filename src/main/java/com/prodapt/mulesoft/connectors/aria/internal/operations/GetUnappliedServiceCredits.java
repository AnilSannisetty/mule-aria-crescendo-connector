...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetUnappliedServiceCreditsParam;
...
public class GetUnappliedServiceCredits {
	...
	public void getUnappliedServiceCredits(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetUnappliedServiceCreditsParam ar,
		...
		String apiName = "get_unapplied_service_credits_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetUnappliedServiceCreditsParam ar) {
