...
public class TransferAcctBalanceParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to transfer the balance from one account to another account.")
	@Optional(defaultValue = "transfer_account_balance_m")
