...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAllAcctContractsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAllAcctContracts {
	private static final Logger logger = LoggerFactory.getLogger(GetAllAcctContracts.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get All Account Contracts")
	@MediaType(value = "application/json")
	@Summary("This operation returns an array of contracts associated with the given account, as well as contract details. You can optionally filter by contract status.")
	public void getAllAcctContracts(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAllAcctContractsParam ar,
		...
		String apiName = "get_all_acct_contracts_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAllAcctContractsParam ar) {
