...
public class ValidateAcctFraudScoringParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that obtains a fraud score and/or a fraud filter response from a payment gateway based on your criteria specified in your payment gateway.")
	@Optional(defaultValue = "validate_acct_fraud_scoring_m")
