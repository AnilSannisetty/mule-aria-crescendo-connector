...
public class ReplaceREGUSSConfigParamsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that replaces the parameter name-value pairs in a particular configuration set with a specified set of new parameter name-value pairs.")
	@Optional(defaultValue = "replace_reg_uss_config_params_m")
