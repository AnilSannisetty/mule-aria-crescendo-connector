...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.CreateCreditMemoParam;
...
public class CreateCreditMemo {
	...
	public void createCreditMemo(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") CreateCreditMemoParam ar,
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, CreateCreditMemoParam ar) {
