...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetSuppPlansByPromoCodeAllParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetSuppPlansByPromoCodeAll{
	private static final Logger logger = LoggerFactory.getLogger(GetSuppPlansByPromoCodeAll.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Supplemental Plans By Promotion Code All")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to return a detailed list of supplemental plans associated with a specified promotion code. The information returned includes the services and rate schedules associated with the plans.")
	public void getSuppPlansByPromoCodeAll(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetSuppPlansByPromoCodeAllParam ar,
		...
		String apiName = "get_supp_plans_by_promo_code_all_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac,
			GetSuppPlansByPromoCodeAllParam ar) {
