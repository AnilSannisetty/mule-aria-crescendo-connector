...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetRefundablePaymentsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetRefundablePayments{
	private static final Logger logger = LoggerFactory.getLogger(GetRefundablePayments.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Refundable Payments")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to return an array of payment transactions for a given acct_no or master plan instance that are considered refundable.")
	public void getRefundablePayments(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetRefundablePaymentsParam ar,
		...
		String apiName = "get_refundable_payments_m";
