...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetPendingInvoiceNoParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetPendingInvoiceNo {
	private static final Logger logger = LoggerFactory.getLogger(GetPendingInvoiceNo.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("CRUD:Get Pending Invoice No")
	@MediaType(value = "application/json")
	@Summary("Use this API to return the invoice number of a pending invoice associated with a specified account or master plan instance. If <acct_no>, or <client_acct_id> is alone passed as an input parameter, then this API returns an array of pending invoices for all master plan instances associated with an account.")
	public void getPendingInvoiceNo(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetPendingInvoiceNoParam ar,
		...
		String apiName = "get_pending_invoice_no_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetPendingInvoiceNoParam ar) {
