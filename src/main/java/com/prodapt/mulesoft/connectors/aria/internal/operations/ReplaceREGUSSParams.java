...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ReplaceREGUSSParamsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ReplaceREGUSSParams {
	private static final Logger logger = LoggerFactory.getLogger(ReplaceREGUSSParams.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Replace Registration USS Parameters")
	...
	public void replaceRegUssParams(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ReplaceREGUSSParamsParam ar,
		...
		String apiName = "replace_reg_uss_params_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ReplaceREGUSSParamsParam ar) {
