...
public class GetCcUuidParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns the universally unique identifier (UUID) for a credit card payment number.")
	@Optional(defaultValue = "get_cc_uuid_m")
