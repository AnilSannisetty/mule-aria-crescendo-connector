...
public class GetPmtUuidParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get the universally unique identifier (UUID) for a credit card payment method.")
	@Optional(defaultValue = "get_pmt_uuid_m")
