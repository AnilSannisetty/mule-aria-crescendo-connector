...
public class GetAcctPlanNotifyMethodParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns the method by which statements are sent for a specified plan instance, or billing group for a given account.")
	@Optional(defaultValue = "get_acct_plan_notify_method_m")
