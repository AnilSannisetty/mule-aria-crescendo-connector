...
public class GetAvailPlansForAcctAllParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to retrieve a list of all plan, (including services, rate schedule details, and supplemental fields), available for assignment on a particular account.")
	@Optional(defaultValue = "get_avail_plans_for_acct_all_m")
