...
public class GetSuppFieldValuesParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns the values for a particular supplemental field associated with a specified account.")
	@Optional(defaultValue = "get_supp_field_values_m")
