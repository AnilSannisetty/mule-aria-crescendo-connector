...
public class GetItemsBySupplementalFieldParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to return the inventory items associated with a particular value for a supplemental object field.")
	@Optional(defaultValue = "get_items_by_supp_field_m")
