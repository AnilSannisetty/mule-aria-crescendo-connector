...
public class CreateWriteoffOrDisputeParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that creates writeoff or dispute-hold for a given invoice.")
	@Optional(defaultValue = "create_writeoff_or_dispute_m")
