...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctUniversalContractParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctUniversalContract {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctUniversalContract.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Universal Contract")
	@MediaType(value = "application/json")
	@Summary("This operation returns any universal contract currently associated with a specified account.")
	public void getAcctUniversalContract(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctUniversalContractParam ar,
		...
		String apiName = "get_acct_universal_contract_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctUniversalContractParam ar) {
