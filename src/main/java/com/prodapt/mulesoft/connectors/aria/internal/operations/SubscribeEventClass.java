...
public class SubscribeEventClass {
	private static final Logger logger = LoggerFactory.getLogger(SubscribeEventClass.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Subscribe Event Class")
	@MediaType(value = "application/json")
	@Summary("This operation subscribes a client to a specified event class.")
	public void subscribeeventclass(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SubscribeEventClassParam ar,
		...
		String apiName = "subscribe_event_class_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SubscribeEventClassParam ar) {
