...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAvailPlansForAcctParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAvailPlansForAcct {
	private static final Logger logger = LoggerFactory.getLogger(GetAvailPlansForAcct.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Available Plans For Account")
	...
	public void getAvailPlansForAcct(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAvailPlansForAcctParam ar,
		...
		String apiName = "get_avail_plans_for_acct_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAvailPlansForAcctParam ar) {
