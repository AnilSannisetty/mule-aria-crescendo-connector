...
public class ValidatePaymentInformationParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that determines the validity of a card by performing an authorization transaction.")
	@Optional(defaultValue = "validate_payment_information_m")
