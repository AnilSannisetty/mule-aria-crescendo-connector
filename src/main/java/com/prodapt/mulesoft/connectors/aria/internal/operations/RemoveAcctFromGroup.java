...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.RemoveAcctFromGroupParam;
...
public class RemoveAcctFromGroup {
	...
	public void removeAcctFromGroup(@Config RestConfiguration rc, @Connection AriaConnection ac,
		...
		String apiName = "remove_acct_from_group_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, RemoveAcctFromGroupParam ar) {
