...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.CreateAdvancedServiceCreditParam;
...
public class CreateAdvancedServiceCredit {
	...
	public void createAdvancedServiceCredit(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") CreateAdvancedServiceCreditParam ar,
		...
		String apiName = "create_advanced_service_credit_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, CreateAdvancedServiceCreditParam ar) {
