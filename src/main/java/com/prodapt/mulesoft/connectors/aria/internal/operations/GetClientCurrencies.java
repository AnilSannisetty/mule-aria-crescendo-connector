...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetClientCurrenciesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetClientCurrencies{
	private static final Logger logger = LoggerFactory.getLogger(GetClientCurrencies.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Client Currencies")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to return a list of currencies assigned to a client.")
	public void getClientCurrencies(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetClientCurrenciesParam ar,
		...
		String apiName = "get_client_currencies_m";
