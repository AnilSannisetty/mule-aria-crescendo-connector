...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyAcctPlanUnitInstanceParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ModifyAcctPlanUnitInstance {
	private static final Logger logger = LoggerFactory.getLogger(ModifyAcctPlanUnitInstance.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("CRUD: Update Account Plan Unit Instance")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to either update fulfillment, or the supplemental field(s) on the unit instances of a plan.")
	public void modifyAcctPlanUnitInstance(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ModifyAcctPlanUnitInstanceParam ar,
		...
		String apiName = "update_acct_plan_unit_instance_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyAcctPlanUnitInstanceParam ar) {
