...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.RecordExternalPaymentParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class RecordExternalPayment {
	private static final Logger logger = LoggerFactory.getLogger(RecordExternalPayment.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Record External Payment")
	@MediaType(value = "application/json")
	@Summary("This operation is used to record a payment transaction for a payment collected from an account holder without using Aria.")
	public void recordExternalPayment(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") RecordExternalPaymentParam ar,
		...
		String apiName = "record_external_payment_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, RecordExternalPaymentParam ar) {
