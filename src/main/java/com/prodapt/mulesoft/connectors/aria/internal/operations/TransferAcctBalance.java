...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.TransferAcctBalanceParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class TransferAcctBalance {
	...
	@Summary("Transfers the balance from one account to another account.")
	public void transferAcctBalance(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") TransferAcctBalanceParam ar,
		...
		String apiName = "transfer_account_balance_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, TransferAcctBalanceParam ar) {
