...
public class GetUsageSummaryByTypeParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns usage records associated with a specified account for a particular date range.")
	@Optional(defaultValue = "get_usage_summary_by_type_m")
