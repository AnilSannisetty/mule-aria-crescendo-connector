...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetClientItemPricesParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetClientItemPrices{
	private static final Logger logger = LoggerFactory.getLogger(GetClientItemPrices.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Client Item Prices")
	@MediaType(value = "application/json")
	@Summary("This operation returns a list of prices for inventory item.")
	public void getClientItemPrices(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetClientItemPricesParam ar,
		...
		String apiName = "get_client_item_prices_m";
