...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SubscribeEventClassParam;
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.UnsubscribeEventClassParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class UnsubscribeEventClass {
	private static final Logger logger = LoggerFactory.getLogger(UnsubscribeEventClass.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Unsubscribe Event Class")
	@MediaType(value = "application/json")
	@Summary("This operatoin unsubscribes a client to a specified event class.")
	public void unsubscribeeventclass(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") UnsubscribeEventClassParam ar,
		...
		String apiName = "unsubscribe_event_class_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, UnsubscribeEventClassParam ar) {
