...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctNotifyMethodParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctNotifyMethod {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctNotifyMethod.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Notify Method")
	@MediaType(value = "application/json")
	@Summary("This operation returns the method by which statements are sent to a specified account.")
	public void getAcctNotifyMethod(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctNotifyMethodParam ar,
		...
		String apiName = "get_acct_notify_method_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctNotifyMethodParam ar) {
