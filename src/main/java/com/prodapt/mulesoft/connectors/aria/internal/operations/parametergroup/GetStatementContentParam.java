...
public class GetStatementContentParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get the contents of a particular statement associated with a specified account.")
	@Optional(defaultValue = "get_statement_content_m")
