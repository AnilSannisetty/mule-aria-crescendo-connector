...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ReplaceAcctPlanParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ReplaceAcctPlan {
	private static final Logger logger = LoggerFactory.getLogger(ReplaceAcctPlan.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Replace Account Plan")
	@MediaType(value = "application/json")
	@Summary("This operation is used to replace an existing master or supplemental plan with a new master or supplemental plan for a specified account.")
	public void replaceAcctPlan(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ReplaceAcctPlanParam ar,
		...
		String apiName = "replace_acct_plan_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ReplaceAcctPlanParam ar) {
