...
public enum AriaErrorTypes implements ErrorTypeDefinition<AriaErrorTypes> {
	 ...
	 */
	  ...
	  AriaErrorTypes(ErrorTypeDefinition<?> parentErrorType) {
		  this.parentErrorType = parentErrorType;
		  this.errorMessageFunction = null;
	  }
	  
	  AriaErrorTypes(ErrorTypeDefinition<?> parentErrorType, Function<HttpRequest, String> errorMessageFunction) {
	    this.parentErrorType = parentErrorType;
	  ...
	  public static Optional<AriaErrorTypes> getErrorByCode(int statusCode) {
		  AriaErrorTypes error = null;
	  ...
	  public static Optional<HttpConstants.HttpStatus> getHttpStatus(AriaErrorTypes error) {
