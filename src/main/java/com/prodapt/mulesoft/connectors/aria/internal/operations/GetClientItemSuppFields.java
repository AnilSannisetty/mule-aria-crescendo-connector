...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetClientItemSuppFieldsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetClientItemSuppFields{
	private static final Logger logger = LoggerFactory.getLogger(GetClientItemSuppFields.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Client Item Supplemental Fields")
	@MediaType(value = "application/json")
	@Summary("This operation returns a list of supplemental fields for inventory item.")
	public void getClientItemSuppFields(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetClientItemSuppFieldsParam ar,
		...
		String apiName = "get_client_item_supp_fields_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac,
			GetClientItemSuppFieldsParam ar) {
