...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctPlansParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctPlans {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctPlans.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Plans")
	@MediaType(value = "application/json")
	@Summary("This operation returns the details of the master and supplemental plans assigned to a specified account.")
	public void getAcctPlans(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctPlansParam ar,
		...
		String apiName = "get_acct_plans_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctPlansParam ar) {
