...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.UserIDIsAvailableParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class UserIDIsAvailable  {
	private static final Logger logger = LoggerFactory.getLogger(UserIDIsAvailable .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("User ID Is Available")
	@MediaType(value = "application/json")
	@Summary("This operation determines whether a specified user ID is available for use.")
			
	public void userIDIsAvailable(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") UserIDIsAvailableParam ar,
		...
		String apiName = "userid_is_available_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, UserIDIsAvailableParam ar) {
