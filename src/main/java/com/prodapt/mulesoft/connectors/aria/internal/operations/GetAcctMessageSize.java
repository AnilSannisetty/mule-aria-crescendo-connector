...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctMessageSizeParam;

import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctMessageSize {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctMessageSize.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Message Size")
	@MediaType(value = "application/json")
	@Summary("This operation returns the size in bytes of the body of a particular email message sent to a specified account holder.")
	public void getAcctMessageSize(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctMessageSizeParam ar,
		...
		String apiName = "get_acct_message_size_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctMessageSizeParam ar) {
