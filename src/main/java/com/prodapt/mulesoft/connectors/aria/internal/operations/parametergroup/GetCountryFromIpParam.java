...
public class GetCountryFromIpParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns the county of origin for a specified IP address.")
	@Optional(defaultValue = "get_country_from_ip_m")
