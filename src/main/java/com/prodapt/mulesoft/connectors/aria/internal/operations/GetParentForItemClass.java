...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetParentForItemClassParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetParentForItemClass {
	private static final Logger logger = LoggerFactory.getLogger(GetParentForItemClass.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Parent For Item Class")
	@MediaType(value = "application/json")
	@Summary("This operation returns the immediate parent classes for that client.")
	public void getParentForItemClass(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetParentForItemClassParam ar,
		...
		String apiName = "get_parent_for_item_class_m ";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetParentForItemClassParam ar) {
