...
public class GetInstanceContractParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that returns a multi-plan instance contract currently associated with a specified account.")
	@Optional(defaultValue = "get_instance_contract_m")
