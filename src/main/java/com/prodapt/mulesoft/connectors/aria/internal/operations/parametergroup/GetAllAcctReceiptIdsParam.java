...
public class GetAllAcctReceiptIdsParam {
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call to get a list of all client receipt IDs associated with a specified account.")
	@Optional(defaultValue = "get_all_acct_receipt_ids_m")
