...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctBalanceParam;
...
public class GetAcctBalance {
	...
	public void getAcctBalance(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctBalanceParam ar,
		...
		String apiName = "get_acct_balance_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctBalanceParam ar) {
