...
public class  CompareAgainstCCBlacklistParam {
	
	@Parameter
	@DisplayName("API Name")
	@Summary("Aria API call that compares a card number provided against entries in the blacklist.")
	@Optional(defaultValue = "compare_against_cc_blacklist_m")
