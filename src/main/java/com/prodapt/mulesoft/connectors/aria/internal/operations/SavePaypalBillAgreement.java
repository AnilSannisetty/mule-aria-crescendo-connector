...
public class SavePaypalBillAgreement {
	...
	public void savePaypalBillAgreement(@Config RestConfiguration rc, @Connection AriaConnection ac,
		...
		String apiName = "save_paypal_bill_agreement_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SavePaypalBillAgreementParam ar) {
