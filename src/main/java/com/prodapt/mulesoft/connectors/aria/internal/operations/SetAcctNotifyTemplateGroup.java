...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.SetAcctNotifyTemplateGroupParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class SetAcctNotifyTemplateGroup  {
	private static final Logger logger = LoggerFactory.getLogger(SetAcctNotifyTemplateGroup .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Set Account Notify Template Group")
	@MediaType(value = "application/json")
	@Summary("This operation is used to assign or de_assign notification template group at the account level.")
			
	public void setAcctNotifyTemplateGroup(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") SetAcctNotifyTemplateGroupParam ar,
		...
		String apiName = "set_acct_notify_tmplt_grp_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, SetAcctNotifyTemplateGroupParam ar) {
