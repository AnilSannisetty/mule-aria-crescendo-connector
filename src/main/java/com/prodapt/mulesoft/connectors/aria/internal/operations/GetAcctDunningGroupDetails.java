...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctDunningGroupDetailsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctDunningGroupDetails {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctDunningGroupDetails.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Dunning Group Details")
	@MediaType(value = "application/json")
	@Summary("This operation can be used to retrieve the details for a specified dunning group, including the list of master plan instances associated with that dunning group.")
	public void getAcctDunningGroupDetails(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctDunningGroupDetailsParam ar,
		...
		String apiName = "get_acct_dunning_group_details_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctDunningGroupDetailsParam ar) {
