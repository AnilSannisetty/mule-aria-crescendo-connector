...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ModifyContactParam;
...
public class ModifyContact {
	...
	@Summary("Updates contact information for Aria accounts or Billing Groups.")
	public void modifyContact(@Config RestConfiguration rc, @Connection AriaConnection ac,
		...
		String apiName = "update_contact_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ModifyContactParam ar) {
