...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.ClearRegUssParametersParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class ClearRegUssParameters  {
	private static final Logger logger = LoggerFactory.getLogger(ClearRegUssParameters .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Clear Reg Uss Parameters")
	@MediaType(value = "application/json")
	@Summary("This operation removes all of the parameter name-value pairs associated with a particular session ID.")
			
	public void clearRegUssParameters(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") ClearRegUssParametersParam ar,
		...
		String apiName = "clear_reg_uss_params_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, ClearRegUssParametersParam ar) {
