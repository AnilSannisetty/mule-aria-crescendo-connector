...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.GetAcctTaxExemptStatusParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class GetAcctTaxExemptStatus {
	private static final Logger logger = LoggerFactory.getLogger(GetAcctTaxExemptStatus.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Get Account Tax Exempt Status")
	@MediaType(value = "application/json")
	@Summary("This operation is used to return an account's tax exemption level (none, federal, state, or both federal and state).")
	public void getAcctTaxExemptStatus(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") GetAcctTaxExemptStatusParam ar,
		...
		String apiName = "get_acct_tax_exempt_status_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, GetAcctTaxExemptStatusParam ar) {
