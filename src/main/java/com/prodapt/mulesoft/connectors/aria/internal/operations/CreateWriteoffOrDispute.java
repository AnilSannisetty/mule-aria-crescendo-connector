...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.CreateWriteoffOrDisputeParam;
...
public class CreateWriteoffOrDispute {
	...
	public void createWriteoffOrDispute(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") CreateWriteoffOrDisputeParam ar,
		...
		String apiName = "create_writeoff_or_dispute_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, CreateWriteoffOrDisputeParam ar) {
