...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.WriteAcctCommentParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class WriteAcctComment  {
	private static final Logger logger = LoggerFactory.getLogger(WriteAcctComment .class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Write Account Comment")
	@MediaType(value = "application/json")
	@Summary("This operation adds comments to a specified account record.")
			
	public void writeAcctComment(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") WriteAcctCommentParam ar,
		...
		String apiName = "write_acct_comment_m";
	...
	private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, WriteAcctCommentParam ar) {
