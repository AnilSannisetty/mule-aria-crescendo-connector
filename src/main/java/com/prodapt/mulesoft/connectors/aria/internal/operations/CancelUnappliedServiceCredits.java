...
import com.prodapt.mulesoft.connectors.aria.internal.operations.parametergroup.CancelUnappliedServiceCreditsParam;
import com.prodapt.mulesoft.connectors.aria.internal.utility.RestRequestBuilder;

public class CancelUnappliedServiceCredits {
	...
	public void cancelUnappliedServiceCredits(@Config RestConfiguration rc, @Connection AriaConnection ac,
			@ParameterGroup(name = "Input Arguments") CancelUnappliedServiceCreditsParam ar,
		...
		String apiName = "cancel_unapplied_service_credits_m";
...
private JSONObject attachStandardParamsToPayload(TypedValue<InputStream> payload, String apiName, AriaConnection ac, CancelUnappliedServiceCreditsParam ar) {
